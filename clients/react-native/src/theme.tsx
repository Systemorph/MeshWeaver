...
const LIGHT: Palette = {
  ...
  textMuted: "#8a8a8a", accent: deployment.branding.accent, onAccent: "#ffffff", navHover: "#ececee",
  navActiveBg: "#e1ebf7", navActiveText: deployment.branding.accent, inputBg: "#ffffff",
};

const DARK: Palette = {
  appBg: "#1b1a19", topbarBg: "#252423", surface: "#2d2c2b", border: "#3b3a39",
  sidebarBg: "#201f1e", rightBg: "#252423", text: "#f3f2f1", textSubtle: "#c8c6c4",
  textMuted: "#979593", accent: deployment.branding.accentDark, onAccent: "#ffffff", navHover: "#323130",
