...
nodeType: Agent
name: Log Triage
description: Triages a red log incident (a distinct fail:/crit: fingerprint seen in production) and drafts the GitHub issue for it — naming the probable defect, picking the owning repository, and writing a ticket an engineer can act on.
