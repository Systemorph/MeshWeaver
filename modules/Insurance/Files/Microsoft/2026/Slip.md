# Microsoft Building Insurance Program

## Broker
**Broker:** Orion Risk Partners Ltd.  
**Contact:** riskdesk@orionrisk.com  
**Address:** 88 Bishopsgate, London EC2N 4AG, United Kingdom

## Primary Insurer
**Insurer:** Sentinel Global Insurance SE  
**Policy Reference:** SGI/MSFT/2025/001
...
- Coverage includes declared values for critical infrastructure, data centers, and cloud service continuity.
- Deductibles and sub-limits apply as per schedule.
- Subject to U.S. law and jurisdiction.
- Claims control and settlement authority retained by Sentinel Global Insurance SE.
- Aggregate deductible for Fire Layer 1 applies across all Fire claims until exhausted.
