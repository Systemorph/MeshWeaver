...
param entraadmingroupid_value = '{{ parameter "EntraAdminGroupId" }}'
...
param meshweaverCertificate2 = '{{ parameter "meshweaverCertificate2" }}'
param meshweaverDomain2 = '{{ parameter "meshweaverDomain2" }}'
