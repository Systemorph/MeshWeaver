...
public static class MeshNodeDataLoader
{
    public static IObservable<IEnumerable<Product>> LoadProductsFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:ACME/Northwind/Product path:{namespacePath}/Product scope:children state:Active"))
    ...
    public static IObservable<IEnumerable<Customer>> LoadCustomersFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:ACME/Northwind/Customer path:{namespacePath}/Customer scope:children state:Active"))
    ...
    public static IObservable<IEnumerable<Employee>> LoadEmployeesFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:ACME/Northwind/Employee path:{namespacePath}/Employee scope:children state:Active"))
    ...
    public static IObservable<IEnumerable<Supplier>> LoadSuppliersFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:ACME/Northwind/Supplier path:{namespacePath}/Supplier scope:children state:Active"))
