...
Title: "Top Sales Representatives of the Month"
...
@@("ACME/Northwind/Analytics/TopEmployeesTable")

  </div>
  <div style="flex: 1;">

@@("ACME/Northwind/Analytics/TopEmployees")

  </div>
</div>

@@("ACME/Northwind/Analytics/TopEmployeesReport")
