...
| Todo NodeType | `ACME/Software/Project/Todo` |
...
The Todo NodeType (`ACME/Software/Project/Todo`) is configured with:

```json
{
  "id": "Todo",
  "namespace": "ACME/Software/Project",
  "name": "Task",
  "nodeType": "NodeType",
  "content": {
...
public static IObservable<UiControl?> TodaysFocus(LayoutAreaHost host, RenderingContext _)
{
    var nodes = meshQuery.ObserveQuery<MeshNode>(
        $"path:{hubPath}/Todo nodeType:ACME/Software/Project/Todo state:Active scope:subtree");
