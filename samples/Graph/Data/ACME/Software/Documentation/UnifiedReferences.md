...
```
path:ACME/Software/CustomerOnboarding/Todo nodeType:ACME/Software/Project/Todo scope:subtree
```

@[ACME/CustomerOnboarding/Todo:nodeType:ACME/Software/Project/Todo:scope:subtree]

**Tasks by Status** (In-progress tasks in ProductLaunch):
```
path:ACME/Software/ProductLaunch/Todo nodeType:ACME/Software/Project/Todo status:InProgress scope:subtree
```

**Tasks by Category** (Legal tasks in CustomerOnboarding):
```
path:ACME/Software/CustomerOnboarding/Todo nodeType:ACME/Software/Project/Todo category:Legal scope:subtree
```

**Tasks by Assignee** (Tasks assigned to Oliver):
```
nodeType:ACME/Software/Project/Todo assignee:Oliver
```
