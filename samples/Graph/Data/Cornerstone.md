...
Explore the Cornerstone client portfolio:

- @Cornerstone/Microsoft
- @Cornerstone/GlobalManufacturing
- @Cornerstone/EuropeanLogistics
- @Cornerstone/TechIndustries
...
- **Overview**: Pricing header with insured details, inception and expiration dates, line of business and currency, broker and primary insurer information and current pricing status 
- **PropertyRisks**: DataGrid showing all property location details with TSI values, construction details (build year, occupancy type) and geocoded coordinates for mapping
- **RiskMap**: Google Maps visualization of geocoded property locations
- **Structure**:  diagram showing reinsurance layers and sections per layer (Fire, Natural Catastrophe, Business Interruption), and financial terms (EPI, rates, commissions)
