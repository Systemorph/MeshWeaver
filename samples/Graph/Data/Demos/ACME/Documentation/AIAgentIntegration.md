...
**Agent Process**:
1. `Search("nodeType:Demos/ACME/Project/Todo category:Compliance")` → Finds compliance-related tasks
...
The ACME sample includes a TodoAgent defined in `Demos/ACME/Project/TodoAgent.md`:
...
2. **Category Discovery**: Agent calls `Get("@Demos/ACME/Project/Todo/schema:")` to see available categories
