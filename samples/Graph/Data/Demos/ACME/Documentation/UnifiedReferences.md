...
| `Demos/ACME/Project` | Shared NodeType definitions |
...
| Path | Description |
|------|-------------|
| `Demos/ACME/Project/Todo` | Todo NodeType (shared) |
| `Demos/ACME/Project/TodoAgent` | AI agent definition |
...
```
path:Demos/ACME/CustomerOnboarding/Todo nodeType:Demos/ACME/Project/Todo scope:subtree
```

@[ACME/CustomerOnboarding/Todo:nodeType:Demos/ACME/Project/Todo:scope:subtree]

**Tasks by Status** (In-progress tasks in ProductLaunch):
```
path:Demos/ACME/ProductLaunch/Todo nodeType:Demos/ACME/Project/Todo status:InProgress scope:subtree
```

**Tasks by Category** (Legal tasks in CustomerOnboarding):
```
path:Demos/ACME/CustomerOnboarding/Todo nodeType:Demos/ACME/Project/Todo category:Legal scope:subtree
```

**Tasks by Assignee** (Tasks assigned to Oliver):
```
nodeType:Demos/ACME/Project/Todo assignee:Oliver
```
...
Defined in `Demos/ACME/Project/Code/Status.cs`:
...
Defined in `Demos/ACME/Project/Todo/Code/Priority.cs`:
...
Defined in `Demos/ACME/Project/Todo/Code/Category.cs`:
...
| Content | Path |
|---------|------|
| Todo icon | `/static/storage/content/Demos/ACME/Project/Todo/icon.svg` |
| Project thumbnails | `/static/storage/content/Demos/ACME/Project/thumbnails/` |
