...
Abstract: "How AI agents integrate with Cornerstone Insurance through MeshPlugin and domain documentation"
Icon: "Document"
...
**Agent Process**:
1. `Search("nodeType:Demos/Cornerstone/Pricing status:Bound")` → Finds bound pricings
