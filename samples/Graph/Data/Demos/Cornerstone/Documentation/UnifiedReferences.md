...
```
nodeType:Demos/Cornerstone/Pricing status:Bound
```

**Pricings by Line of Business** (Property pricings):
```
nodeType:Demos/Cornerstone/Pricing lineOfBusiness:PROP
```

**Pricings for an Insured** (Microsoft pricings):
```
path:Demos/Cornerstone/Microsoft nodeType:Demos/Cornerstone/Pricing scope:subtree
```

**All Insureds**:
```
nodeType:Demos/Cornerstone/Insured
```
...
| Code | Name | Country |
|------|------|---------|
| CS-US | Cornerstone Insurance US Inc. | United States |
| CS-UK | Cornerstone Insurance UK Ltd. | United Kingdom |
| CS-EU | Cornerstone Insurance Europe AG | Switzerland |
| CS-ASIA | Cornerstone Insurance Asia Pte. Ltd. | Singapore |
