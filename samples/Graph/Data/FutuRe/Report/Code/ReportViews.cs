// <meshweaver>
// Id: ReportViews
// DisplayName: FutuRe Report Views
// </meshweaver>
...
/// <summary>
/// Views for FutuRe Report nodes.
/// </summary>
public static class ReportViews
{
    /// <summary>
    /// Registers report views with the layout definition.
    /// </summary>
    public static LayoutDefinition AddReportViews(this LayoutDefinition layout) =>
        layout
            .WithView("Overview", Overview)
            .WithView("Thumbnail", Thumbnail);

    /// <summary>
    /// Overview view showing report content with metadata header.
    /// </summary>
    public static IObservable<UiControl?> Overview(LayoutAreaHost host, RenderingContext _)
    {
        ...
        return nodeStream.Select(nodes =>
        {
            ...
            if (node == null)
                return (UiControl?)Controls.Markdown("*Loading report...*");

            return (UiControl?)BuildReportOverview(host, node);
        });
    }

    private static UiControl BuildReportOverview(LayoutAreaHost host, MeshNode node)
    {
        ...
        container = container.WithView(
            Controls.Html($"<h1 style=\"margin: 0 0 8px 0;\">{System.Web.HttpUtility.HtmlEncode(node.Name ?? "Report")}</h1>"));
