...
Description: How AI agents integrate with MeshWeaver through remote control patterns and the MeshPlugin
...
The ACME sample includes a TodoAgent defined in `ACME/Project/TodoAgent.md`:
