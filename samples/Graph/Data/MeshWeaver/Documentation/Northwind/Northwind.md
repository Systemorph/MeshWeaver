---
Name: Northwind Case Studies
Category: Documentation
Description: Learn MeshWeaver through the Northwind Traders gourmet food analytics sample
...
| Topic | Go here |
|-------|---------|
| Get up and running | [Getting Started](MeshWeaver/Documentation/Northwind/GettingStarted) - Setup, navigation, first steps |
| Understand the architecture | [Architecture](MeshWeaver/Documentation/Northwind/Architecture) - Data model, views, analytics pipeline |
| Add AI to your app | [AI Agent Integration](MeshWeaver/Documentation/Northwind/AIAgentIntegration) - NorthwindAgent, analytics queries |
| Reference paths and queries | [Unified References](MeshWeaver/Documentation/Northwind/UnifiedReferences) - Paths, queries, layout areas |
