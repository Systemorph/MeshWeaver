...
public static class MeshNodeDataLoader
{
    public static IObservable<IEnumerable<Product>> LoadProductsFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .Query<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:Northwind/Product namespace:{namespacePath}/Product state:Active"))
    ...
    public static IObservable<IEnumerable<Customer>> LoadCustomersFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .Query<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:Northwind/Customer namespace:{namespacePath}/Customer state:Active"))
    ...
    public static IObservable<IEnumerable<Employee>> LoadEmployeesFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .Query<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:Northwind/Employee namespace:{namespacePath}/Employee state:Active"))
    ...
    public static IObservable<IEnumerable<Supplier>> LoadSuppliersFromNodes(IWorkspace workspace)
    {
        ...
        return meshQuery
            .Query<MeshNode>(MeshQueryRequest.FromQuery($"nodeType:Northwind/Supplier namespace:{namespacePath}/Supplier state:Active"))
