...
Abstract: "Explore the Northwind analytics sample and learn MeshWeaver data visualization through practical examples"
Icon: "Document"
...
The Northwind sample demonstrates MeshWeaver's analytics capabilities through a realistic business scenario: a gourmet food distribution company with sales, customer, product, and employee analytics.
...
- **[Northwind Architecture](Northwind/Documentation/Architecture)**: Data loading, virtual cube, view patterns
