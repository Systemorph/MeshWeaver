// <meshweaver>
// Id: Testing/CompilerPipeline/AdoptTimeFrameworkIdentityTest
// DisplayName: Testing/CompilerPipeline/AdoptTimeFrameworkIdentityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
