// <meshweaver>
// Id: Testing/CompilerPipeline/AdoptedTypeIsNotJudgedFromAStaleSnapshotTest
// DisplayName: Testing/CompilerPipeline/AdoptedTypeIsNotJudgedFromAStaleSnapshotTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class AdoptedTypeIsNotJudgedFromAStaleSnapshotTest
{
    ...
    [MeshTheory]
    [MeshInlineData(24, true)]   // strictly older than the write ⇒ superseded
    [MeshInlineData(25, true)]   // the very version the write went over ⇒ superseded
    [MeshInlineData(26, false)]  // the write, or something after it ⇒ the snapshot wins
