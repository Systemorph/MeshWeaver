// <meshweaver>
// Id: Testing/CompilerPipeline/AssemblyCacheRetentionTest
// DisplayName: Testing/CompilerPipeline/AssemblyCacheRetentionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class AssemblyCacheRetentionTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("v7-22825f59-9f4455cd1122.dll", "22825f59")]
    [MeshInlineData("v7-22825F59-9F4455CD1122.pdb", "22825f59")]
    [MeshInlineData("v1234567890-2f9763d7-abcdef012345.dll", "2f9763d7")]
    ...
    [MeshInlineData("v7-g22825f5-9f4455cd1122.dll", "g22825f5")]
    [MeshInlineData("v7-G22825F5-9F4455CD1122.pdb", "g22825f5")]
    ...
    [MeshTheory]
    [MeshInlineData("v7-9f4455cd1122.dll")]           // pre-tag legacy: two segments
    [MeshInlineData("v7-22825f59-abc-def.dll")]       // four segments
    [MeshInlineData("keys.xml")]                      // not ours at all
    [MeshInlineData(".bake-lease-22825f59")]          // the lease
    [MeshInlineData("vX-22825f59-9f4455cd1122.dll")]  // no version
    [MeshInlineData("v7-zzzzzzzz-9f4455cd1122.dll")]  // tag is not hex
    [MeshInlineData("v7-gz2825f5-9f4455cd1122.dll")]  // g-tag whose remainder is not hex
    [MeshInlineData("v7-g2825f5-9f4455cd1122.dll")]   // g-tag one char short
    ...
    [MeshInlineData("v1-ab-cd.dll")]                  // hex, three segments, but nothing this store wrote
    [MeshInlineData("v7-22825f5-9f4455cd1122.dll")]   // tag one char short
    [MeshInlineData("v7-22825f590-9f4455cd1122.dll")] // tag one char long
    [MeshInlineData("v7-22825f59-9f4455cd112.dll")]   // hash one char short
    [MeshInlineData("v7-22825f59-9f4455cd11223.dll")] // hash one char long
