// <meshweaver>
// Id: Testing/CompilerPipeline/BuildDeliveryHoldTest
// DisplayName: Testing/CompilerPipeline/BuildDeliveryHoldTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class BuildDeliveryHoldTest
{
    ...
    [MeshTheory]
    [MeshInlineData("1.2.2", "1.2.3", ModuleVersionVerdict.Compatible)]
    [MeshInlineData("1.2.2", "1.3", ModuleVersionVerdict.Compatible)]
    [MeshInlineData("v1.9.0", "1.10.0-ci.12", ModuleVersionVerdict.Compatible)]
    [MeshInlineData("1.2.2", "2.0.0", ModuleVersionVerdict.Incompatible)]
    [MeshInlineData("2.0.0", "1.9.9", ModuleVersionVerdict.Incompatible)]
    [MeshInlineData(null, "1.2.3", ModuleVersionVerdict.Unknown)]
    [MeshInlineData("1.2.2", null, ModuleVersionVerdict.Unknown)]
    [MeshInlineData("main", "1.2.3", ModuleVersionVerdict.Unknown)]
    [MeshInlineData("", "", ModuleVersionVerdict.Unknown)]
