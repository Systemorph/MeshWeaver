// <meshweaver>
// Id: Testing/CompilerPipeline/CellSurfaceRefusedBuildTest
// DisplayName: Testing/CompilerPipeline/CellSurfaceRefusedBuildTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class CellSurfaceRefusedBuildTest(MeshTestContext context) : InMeshTestBase(output)
{
