// <meshweaver>
// Id: Testing/CompilerPipeline/CodeIncludePatternTest
// DisplayName: Testing/CompilerPipeline/CodeIncludePatternTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class CodeIncludePatternTest
{
    ...
    [MeshTheory]
    [MeshInlineData("embed with <c>@@(\"area/CoverCta\")</c> under the hero")]
    [MeshInlineData("\"the self-embed @@(\\\"area/CoverCta\\\") suppresses the type's panel\");")]
    [MeshInlineData("\"hero…\\n\\n@@(\\\"Install/area/CoverCta\\\")\\n\\nmore\"),")]
    [MeshInlineData("/// one <c>@@(\"Quiz/area/Quiz\")</c> uses: a small sibling INSTANCE node")]
    [MeshInlineData("return $\"@@(\\\"{target}/area/{area}\\\")\";")]
    [MeshInlineData("@@\"quoted\"")]
    [MeshInlineData("@@(paren")]
    [MeshInlineData("@@<markup>")]
    ...
    [MeshTheory]
    [MeshInlineData("@@Store/Plugin/Source/PluginGate", "Store/Plugin/Source/PluginGate")]
    [MeshInlineData("// include the shared helper: @@Edu/Shared/NodeContent", "Edu/Shared/NodeContent")]
    [MeshInlineData("@@Doc/Architecture/Plugins.md", "Doc/Architecture/Plugins.md")]
    [MeshInlineData("@@my-space/sub_dir/File", "my-space/sub_dir/File")]
    ...
    [MeshTheory]
    [MeshInlineData("@@Doc/Guide, then more prose", "Doc/Guide")]
    [MeshInlineData("(@@Doc/Guide)", "Doc/Guide")]
    ...
    [MeshInlineData("Edu/Shared/NodeContent", "Store/Plugin/Source/PluginGate", "Edu/Shared/NodeContent")]
