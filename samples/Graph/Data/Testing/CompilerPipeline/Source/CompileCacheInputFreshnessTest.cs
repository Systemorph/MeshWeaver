// <meshweaver>
// Id: Testing/CompilerPipeline/CompileCacheInputFreshnessTest
// DisplayName: Testing/CompilerPipeline/CompileCacheInputFreshnessTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class CompileCacheInputFreshnessTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshInlineData(true, false)]
    [MeshInlineData(false, true)]
