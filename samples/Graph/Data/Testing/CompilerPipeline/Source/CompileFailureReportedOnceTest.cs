// <meshweaver>
// Id: Testing/CompilerPipeline/CompileFailureReportedOnceTest
// DisplayName: Testing/CompilerPipeline/CompileFailureReportedOnceTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
