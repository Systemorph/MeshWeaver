// <meshweaver>
// Id: Testing/CompilerPipeline/CompiledDependencyRecordTest
// DisplayName: Testing/CompilerPipeline/CompiledDependencyRecordTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
