// <meshweaver>
// Id: Testing/CompilerPipeline/EmitCanaryControlTest
// DisplayName: Testing/CompilerPipeline/EmitCanaryControlTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
