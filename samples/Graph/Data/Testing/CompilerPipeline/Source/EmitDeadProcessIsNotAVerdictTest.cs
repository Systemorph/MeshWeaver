// <meshweaver>
// Id: Testing/CompilerPipeline/EmitDeadProcessIsNotAVerdictTest
// DisplayName: Testing/CompilerPipeline/EmitDeadProcessIsNotAVerdictTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class EmitDeadProcessIsNotAVerdictTest
{
    ...
    [MeshTheory]
    [MeshInlineData("OK")]
    [MeshInlineData("INCONCLUSIVE")]
    [MeshInlineData("DIVERGENT")]
