// <meshweaver>
// Id: Testing/CompilerPipeline/EmitReferenceCaptureBoundaryTest
// DisplayName: Testing/CompilerPipeline/EmitReferenceCaptureBoundaryTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
