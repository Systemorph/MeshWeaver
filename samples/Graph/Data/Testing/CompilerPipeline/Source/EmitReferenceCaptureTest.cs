// <meshweaver>
// Id: Testing/CompilerPipeline/EmitReferenceCaptureTest
// DisplayName: Testing/CompilerPipeline/EmitReferenceCaptureTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public sealed class EmitReferenceCaptureTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData(null, null, null)]
    [MeshInlineData(null, "1", "/tmp/runner")]
    [MeshInlineData("false", "1", "/tmp/runner")]
    [MeshInlineData("true", null, "/tmp/runner")]
    [MeshInlineData("true", "0", "/tmp/runner")]
    [MeshInlineData("true", "1", null)]
    [MeshInlineData("true", "1", "relative-runner")]
