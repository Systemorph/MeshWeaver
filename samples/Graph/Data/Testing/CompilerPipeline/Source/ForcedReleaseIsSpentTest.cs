// <meshweaver>
// Id: Testing/CompilerPipeline/ForcedReleaseIsSpentTest
// DisplayName: Testing/CompilerPipeline/ForcedReleaseIsSpentTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
