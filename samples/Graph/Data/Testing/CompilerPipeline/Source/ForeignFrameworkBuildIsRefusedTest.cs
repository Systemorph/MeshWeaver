// <meshweaver>
// Id: Testing/CompilerPipeline/ForeignFrameworkBuildIsRefusedTest
// DisplayName: Testing/CompilerPipeline/ForeignFrameworkBuildIsRefusedTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ForeignFrameworkBuildIsRefusedTest(MeshTestContext context) : InMeshTestBase(output)
{
