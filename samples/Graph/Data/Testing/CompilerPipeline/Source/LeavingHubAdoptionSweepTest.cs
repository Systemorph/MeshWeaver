// <meshweaver>
// Id: Testing/CompilerPipeline/LeavingHubAdoptionSweepTest
// DisplayName: Testing/CompilerPipeline/LeavingHubAdoptionSweepTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class LeavingHubAdoptionSweepTest(MeshTestContext context) : InMeshTestBase(output)
{
