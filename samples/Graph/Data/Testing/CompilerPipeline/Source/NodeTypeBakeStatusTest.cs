// <meshweaver>
// Id: Testing/CompilerPipeline/NodeTypeBakeStatusTest
// DisplayName: Testing/CompilerPipeline/NodeTypeBakeStatusTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class NodeTypeBakeStatusTest
{
    ...
    [MeshTheory]
    [MeshInlineData(BakeState.Baked)]
    [MeshInlineData(BakeState.NeverBuilt)]
    [MeshInlineData(BakeState.FrameworkStale)]
    [MeshInlineData(BakeState.BytesMissing)]
