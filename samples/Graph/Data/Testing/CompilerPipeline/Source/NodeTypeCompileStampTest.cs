// <meshweaver>
// Id: Testing/CompilerPipeline/NodeTypeCompileStampTest
// DisplayName: Testing/CompilerPipeline/NodeTypeCompileStampTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class NodeTypeCompileStampTest
{
    ...
    [MeshTheory]
    [MeshInlineData(null)]
    [MeshInlineData("fresh-input-evidence")]
