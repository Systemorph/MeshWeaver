// <meshweaver>
// Id: Testing/CompilerPipeline/RecursiveCompilationTest
// DisplayName: Testing/CompilerPipeline/RecursiveCompilationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
