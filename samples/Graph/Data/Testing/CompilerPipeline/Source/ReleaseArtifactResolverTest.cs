// <meshweaver>
// Id: Testing/CompilerPipeline/ReleaseArtifactResolverTest
// DisplayName: Testing/CompilerPipeline/ReleaseArtifactResolverTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
