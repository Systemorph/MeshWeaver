// <meshweaver>
// Id: Testing/CompilerPipeline/ReleaseRecutAdoptsItsOwnCollisionTest
// DisplayName: Testing/CompilerPipeline/ReleaseRecutAdoptsItsOwnCollisionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ReleaseRecutAdoptsItsOwnCollisionTest
{
    ...
    [MeshTheory]
    [MeshInlineData("Node already exists: Edu/CourseInvite/Release/20260906094912-EsO3j1xI")]
    [MeshInlineData("Node already exists at path: Edu/CourseInvite/Release/20260906094912-EsO3j1xI")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(NodeCreationRejectionReason.ValidationFailed)]
    [MeshInlineData(NodeCreationRejectionReason.InvalidNodeType)]
    [MeshInlineData(NodeCreationRejectionReason.InvalidPath)]
    [MeshInlineData(NodeCreationRejectionReason.Unknown)]
