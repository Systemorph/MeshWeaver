// <meshweaver>
// Id: Testing/CompilerPipeline/RetiredContextCollectedSignalTest
// DisplayName: Testing/CompilerPipeline/RetiredContextCollectedSignalTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
