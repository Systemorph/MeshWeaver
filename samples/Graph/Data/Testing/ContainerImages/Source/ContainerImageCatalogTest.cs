// <meshweaver>
// Id: Testing/ContainerImages/ContainerImageCatalogTest
// DisplayName: Testing/ContainerImages/ContainerImageCatalogTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ContainerImageCatalogTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("team/service", "a-b")]
    [MeshInlineData("team-service", "a/b")]
    [MeshInlineData("team/service", "a/b")]
    [MeshInlineData("team-service", "a-b")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("a/b/c", "latest")]
    [MeshInlineData("../escape", "latest")]
    [MeshInlineData("repo", "../../secret")]
    [MeshInlineData("repo", "sha256:0123456789abcdef")]
    [MeshInlineData("", "")]
