// <meshweaver>
// Id: Testing/ContentCollections/ContentSyncIsNeverBuiltWholeTest
// DisplayName: Testing/ContentCollections/ContentSyncIsNeverBuiltWholeTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ContentSyncIsNeverBuiltWholeTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
...
/// another.</para>
/// </summary>
public class ContentSyncMirrorSurvivesTheSplitTest(MeshTestContext context) : InMeshTestBase(output)
{
    private const int FileBytes = 300_000;
    private const int FileCount = 8;
    private const string NodePath = "host/1";
