// <meshweaver>
// Id: Testing/ContentCollections/ImageContentGuardTest
// DisplayName: Testing/ContentCollections/ImageContentGuardTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ImageContentGuardTest : InMeshTestBase
{
    private readonly string _contentBasePath = Path.Combine(AppContext.BaseDirectory, "Files", "ImageGuardTest");

    public ImageContentGuardTest(MeshTestContext context) : base(context)
    {
