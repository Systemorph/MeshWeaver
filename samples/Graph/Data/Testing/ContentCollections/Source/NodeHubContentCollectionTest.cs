// <meshweaver>
// Id: Testing/ContentCollections/NodeHubContentCollectionTest
// DisplayName: Testing/ContentCollections/NodeHubContentCollectionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class NodeHubContentCollectionTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    public async Task NodeHub_Content_Collection_Can_Be_Resolved()
    {
        ...
        var collection = await contentService.GetCollection("content").FirstAsync().Await(CancellationToken.None);
    ...
    public async Task NodeHub_Content_Collection_Supports_File_Operations()
    {
        ...
        await collection!.SaveFile("/", "test.txt", stream).Await(CancellationToken.None);
