// <meshweaver>
// Id: Testing/ContentCollections/ObservableCollectionSurfaceTest
// DisplayName: Testing/ContentCollections/ObservableCollectionSurfaceTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </list>
/// </summary>
public class ObservableCollectionSurfaceTest(MeshTestContext context) : InMeshTestBase(output)
{
