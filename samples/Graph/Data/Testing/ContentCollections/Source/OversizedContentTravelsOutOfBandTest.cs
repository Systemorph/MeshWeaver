// <meshweaver>
// Id: Testing/ContentCollections/OversizedContentTravelsOutOfBandTest
// DisplayName: Testing/ContentCollections/OversizedContentTravelsOutOfBandTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class OversizedContentTravelsOutOfBandTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
...
/// </summary>
public class RefusedOutOfBandContentStillSaysWhyTest(MeshTestContext context) : InMeshTestBase(output)
{
    private const int OversizedBytes = 2_000_000;
    private const string NodePath = "host/1";
...
/// </summary>
public class UnresolvableStagedHandleIsALoudFailureTest(MeshTestContext context) : InMeshTestBase(output)
{
    private readonly string contentPath = Path.Combine(
