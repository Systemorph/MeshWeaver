// <meshweaver>
// Id: Testing/Data/AccessRestrictionTest
// DisplayName: Testing/Data/AccessRestrictionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class TypeLevelAccessRestrictionTest(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class RowLevelAccessRestrictionTest(MeshTestContext context) : InMeshTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
...
/// </summary>
public class GlobalAccessRestrictionTest(MeshTestContext context) : InMeshTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
...
/// </summary>
public class CombinedAccessRestrictionTest(MeshTestContext context) : InMeshTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
