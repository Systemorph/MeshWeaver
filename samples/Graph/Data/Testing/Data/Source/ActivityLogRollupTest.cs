// <meshweaver>
// Id: Testing/Data/ActivityLogRollupTest
// DisplayName: Testing/Data/ActivityLogRollupTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ActivityLogRollupTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(LogLevel.Information, ActivityStatus.Succeeded)]
    [MeshInlineData(LogLevel.Warning, ActivityStatus.Warning)]
    [MeshInlineData(LogLevel.Error, ActivityStatus.Failed)]
    [MeshInlineData(LogLevel.Critical, ActivityStatus.Failed)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(LogLevel.Trace, ActivityStatus.Succeeded, false)]
    [MeshInlineData(LogLevel.Information, ActivityStatus.Succeeded, false)]
    [MeshInlineData(LogLevel.Warning, ActivityStatus.Warning, false)]
    [MeshInlineData(LogLevel.Error, ActivityStatus.Failed, true)]
