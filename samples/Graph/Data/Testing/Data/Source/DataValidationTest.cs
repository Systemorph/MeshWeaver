// <meshweaver>
// Id: Testing/Data/DataValidationTest
// DisplayName: Testing/Data/DataValidationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public abstract class DataValidationTestBase(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class DataCreateValidatorTest(MeshTestContext context) : DataValidationTestBase(output)
{
...
/// </summary>
public class DataUpdateValidatorTest(MeshTestContext context) : DataValidationTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
...
/// </summary>
public class DataDeleteValidatorTest(MeshTestContext context) : DataValidationTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
...
/// </summary>
public class DataReadValidatorTest(MeshTestContext context) : DataValidationTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
...
/// </summary>
public class DataCombinedValidatorTest(MeshTestContext context) : DataValidationTestBase(output)
{
    protected CancellationToken TestTimeout => new CancellationTokenSource(10.Seconds()).Token;
