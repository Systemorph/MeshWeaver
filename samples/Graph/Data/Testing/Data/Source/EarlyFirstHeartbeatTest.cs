// <meshweaver>
// Id: Testing/Data/EarlyFirstHeartbeatTest
// DisplayName: Testing/Data/EarlyFirstHeartbeatTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class EarlyFirstHeartbeatTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
