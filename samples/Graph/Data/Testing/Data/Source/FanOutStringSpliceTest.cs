// <meshweaver>
// Id: Testing/Data/FanOutStringSpliceTest
// DisplayName: Testing/Data/FanOutStringSpliceTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </list>
/// </summary>
public class FanOutStringSpliceTest(MeshTestContext context) : InMeshTestBase(context)
{
    ...
    [MeshTheory]
    [MeshInlineData("splice")]
    [MeshInlineData("replace")]
    [MeshInlineData("add")]
