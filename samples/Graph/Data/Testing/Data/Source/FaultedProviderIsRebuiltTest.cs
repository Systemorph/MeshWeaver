// <meshweaver>
// Id: Testing/Data/FaultedProviderIsRebuiltTest
// DisplayName: Testing/Data/FaultedProviderIsRebuiltTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class FaultedProviderIsRebuiltTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshInlineData(2, 2)]
    [MeshInlineData(3, 4)]
    [MeshInlineData(7, 60)]     // 64s would exceed the ceiling
    [MeshInlineData(40, 60)]
