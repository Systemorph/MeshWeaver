// <meshweaver>
// Id: Testing/Data/PivotConfigurationExtensionsTest
// DisplayName: Testing/Data/PivotConfigurationExtensionsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PivotConfigurationExtensionsTest
{
    ...
    public void ToPivotGrid_PreservesDataCollection()
    {
        ...
        data.Should().BeEquivalentTo(TestData, System.Text.Json.JsonSerializerOptions.Default);
    }
