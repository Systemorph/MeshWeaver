// <meshweaver>
// Id: Testing/Data/SchemaTests
// DisplayName: Testing/Data/SchemaTests — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class SchemaTests(MeshTestContext context) : InMeshTestBase(output)
{    /// <summary>
    ...
    public async Task SchemaReference_ForUnknownType_ShouldReturnEmptySchema()
    {
        ...
        // act
        var response = await client.Observe(new GetDataRequest(new SchemaReference(unknownTypeName)), o => o.WithTarget(CreateClientAddress())).Should().Within(10.Seconds()).Emit();
