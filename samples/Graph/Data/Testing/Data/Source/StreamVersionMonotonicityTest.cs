// <meshweaver>
// Id: Testing/Data/StreamVersionMonotonicityTest
// DisplayName: Testing/Data/StreamVersionMonotonicityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// failure mode.</para>
/// </summary>
public class StreamVersionMonotonicityTest(MeshTestContext context) : InMeshTestBase(output)
{
