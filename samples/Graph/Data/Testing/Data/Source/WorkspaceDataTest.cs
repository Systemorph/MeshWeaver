// <meshweaver>
// Id: Testing/Data/WorkspaceDataTest
// DisplayName: Testing/Data/WorkspaceDataTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class WorkspaceDataTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
    ...
    public async Task Workspace_FilterByPredicate_ShouldReturnMatchingItems()
    {
        ...
        activeItems.Should().AllSatisfy(item => item.IsActive.Should().BeTrue());
         ...
         /// </summary>
    [MeshFact(TimeoutSeconds = 30)] // 30 second timeout to prevent hanging
