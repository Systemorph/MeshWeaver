// <meshweaver>
// Id: Testing/Documentation/IdentityReadsRunAsSystemGuard
// DisplayName: Testing/Documentation/IdentityReadsRunAsSystemGuard — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class IdentityReadsRunAsSystemGuard
{
    ...
    public void Pre_identity_reads_run_as_system()
    {
        ...
        Assert.True(
            ...
            + "AsSystem(AccessService, () => …) — never Observable.Using(() => "
