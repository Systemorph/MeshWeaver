// <meshweaver>
// Id: Testing/Documentation/KernelPlaceholdersFollowTheViewerGuard
// DisplayName: Testing/Documentation/KernelPlaceholdersFollowTheViewerGuard — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class KernelPlaceholdersFollowTheViewerGuard
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(null, false, "markdown-kernel-disabled", DisabledKey)]
    [MeshInlineData("rbuergi/Doc", false, "markdown-kernel-pending", StartingKey)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(DisabledKey)]
    [MeshInlineData(StartingKey)]
