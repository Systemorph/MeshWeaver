// <meshweaver>
// Id: Testing/Documentation/LocalOverlayAsksInsteadOfAnsweringTest
// DisplayName: Testing/Documentation/LocalOverlayAsksInsteadOfAnsweringTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class LocalOverlayAsksInsteadOfAnsweringTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Authentication__EnableDevLogin")]
    [MeshInlineData("Authentication__DevAdminUsers")]
    [MeshInlineData("Authentication__Provider")]
    [MeshInlineData("Authentication__Microsoft__ClientId")]
    [MeshInlineData("Authentication__Microsoft__TenantId")]
    [MeshInlineData("Authentication__Microsoft__ClientSecret")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Graph__Storage__Type")]
    [MeshInlineData("Graph__Storage__BasePath")]
