// <meshweaver>
// Id: Testing/Documentation/PlatformVersionSchemeGuard
// DisplayName: Testing/Documentation/PlatformVersionSchemeGuard — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PlatformVersionSchemeGuard
{
    ...
    [MeshTheory]
    // The scheme.
    [MeshInlineData("3.0.0", true)]
    [MeshInlineData("3.0.0-ci.0", true)]
    [MeshInlineData("3.0.0-ci.7989", true)]
    [MeshInlineData("4.12.7-ci.1", true)]
    // The retired rc line — both the label alone and the `.ci.` separator it minted.
    [MeshInlineData("3.0.0-rc8", false)]
    [MeshInlineData("3.0.0-rc13", false)]
    [MeshInlineData("3.0.0-rc9.ci.7818", false)]
    // Labels that were never minted here and never may be.
    [MeshInlineData("3.0.0-preview1", false)]
    [MeshInlineData("3.0.0-beta.1", false)]
    [MeshInlineData("3.0.0-alpha", false)]
    // Near-misses: the suffix must be exactly `-ci.<digits>`, case included.
    [MeshInlineData("3.0.0-CI.7989", false)]
    [MeshInlineData("3.0.0-ci", false)]
    [MeshInlineData("3.0.0-ci.", false)]
    [MeshInlineData("3.0.0-ci.abc", false)]
    [MeshInlineData("3.0.0.7989", false)]
    [MeshInlineData("3.0-ci.7989", false)]
