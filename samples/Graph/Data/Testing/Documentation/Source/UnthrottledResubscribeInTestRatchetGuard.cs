// <meshweaver>
// Id: Testing/Documentation/UnthrottledResubscribeInTestRatchetGuard
// DisplayName: Testing/Documentation/UnthrottledResubscribeInTestRatchetGuard — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// <c>[MeshFact(Timeout)]</c>, <c>methodTimeout</c>, and <c>MonolithMeshTestBase</c>'s hard-deadline
...
/// </summary>
public class UnthrottledResubscribeInTestRatchetGuard(MeshTestContext context)
{
    /// <summary>
