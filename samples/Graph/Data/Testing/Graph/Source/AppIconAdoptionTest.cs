// <meshweaver>
// Id: Testing/Graph/AppIconAdoptionTest
// DisplayName: Testing/Graph/AppIconAdoptionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class AppIconAdoptionTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
