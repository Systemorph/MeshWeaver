// <meshweaver>
// Id: Testing/Graph/BundleContentTest
// DisplayName: Testing/Graph/BundleContentTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class BundleContentTest
{
    ...
    [MeshTheory]
    [MeshInlineData("../escaped.json")]                    // parent traversal
    [MeshInlineData("Module/../../escaped.json")]          // traversal mid-path
    [MeshInlineData("/etc/passwd")]                        // rooted
    [MeshInlineData("C:/Windows/system.ini")]              // drive-qualified
    [MeshInlineData("Module\\Source\\X.cs")]                 // Windows separator
