// <meshweaver>
// Id: Testing/Graph/CodeNodeSegmentNameValidatorTest
// DisplayName: Testing/Graph/CodeNodeSegmentNameValidatorTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class CodeNodeSegmentNameValidatorTest
{
    ...
    [MeshTheory]
    [MeshInlineData("Source")]
    [MeshInlineData("Test")]
    [MeshInlineData("source")] // routing's segment check is case-insensitive, so the hole is too
    ...
    [MeshInlineData("Spine", "Acme/Model/Source", CodeNodeType.NodeType)]
    // Nested below it. Namespace contains /Source/ → covered by the widened pattern.
    [MeshInlineData("Fixtures", "Acme/Model/Source/Helpers", CodeNodeType.NodeType)]
    // A Code node named 'Test' INSIDE a Source folder: namespace 'Acme/Model/Source' → covered.
    [MeshInlineData("Test", "Acme/Model/Source", CodeNodeType.NodeType)]
    // A Source/Test FOLDER is a Group, not Code — the required layout, untouched by the rule.
    [MeshInlineData("Source", "Acme/Model", "Group")]
    [MeshInlineData("Test", "Acme/Model", "Markdown")]
    ...
    [MeshInlineData("Acme/Model/Source", true)]
    [MeshInlineData("Acme/Model/Test", true)]
    // Legal placements — all covered by a global pattern, none forbidden.
    [MeshInlineData("Acme/Model/Source/Spine", false)]
    [MeshInlineData("Acme/Model/Source/Helpers/Deep", false)]
    [MeshInlineData("Acme/Model/Source/Test", false)]   // namespace 'Acme/Model/Source' matches */Source
...
/// </summary>
public class CodeNodeSegmentNameValidatorRegistrationTest(MeshTestContext context)
