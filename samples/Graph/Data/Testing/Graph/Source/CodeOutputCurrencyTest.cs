// <meshweaver>
// Id: Testing/Graph/CodeOutputCurrencyTest
// DisplayName: Testing/Graph/CodeOutputCurrencyTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class CodeOutputCurrencyTest
{
    ...
    [MeshInlineData(true, false, false, null)]
    [MeshInlineData(true, false, false, "")]
    // Only the activity pointer survived — the field the output pane keys on.
    [MeshInlineData(false, true, false, null)]
    // Only the runner survived.
    [MeshInlineData(false, false, true, null)]
    // Everything that says "it ran" is there; only the proof of WHAT ran is missing.
    [MeshInlineData(true, true, true, null)]
    [MeshInlineData(true, true, true, "")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(Source, CodeOutputCurrency.Current)]
