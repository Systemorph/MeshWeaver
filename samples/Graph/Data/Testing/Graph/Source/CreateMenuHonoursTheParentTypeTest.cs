// <meshweaver>
// Id: Testing/Graph/CreateMenuHonoursTheParentTypeTest
// DisplayName: Testing/Graph/CreateMenuHonoursTheParentTypeTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class CreateMenuHonoursTheParentTypeTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <inheritdoc />
    ...
    /// </summary>
    [MeshFact(TimeoutSeconds = 240)] // literal: an attribute argument must be a constant (TestTimeouts.TestMilliseconds is not).
    ...
    /// </summary>
    [MeshFact(TimeoutSeconds = 240)] // literal: an attribute argument must be a constant.
