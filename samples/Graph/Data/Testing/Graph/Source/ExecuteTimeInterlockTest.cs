// <meshweaver>
// Id: Testing/Graph/ExecuteTimeInterlockTest
// DisplayName: Testing/Graph/ExecuteTimeInterlockTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ExecuteTimeInterlockTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshInlineData(BuildProvenance.AdoptedUnverified)]
    [MeshInlineData(BuildProvenance.AdoptedVerified)]
    [MeshInlineData(BuildProvenance.Compiled)]
