// <meshweaver>
// Id: Testing/Graph/ImportTypeBeforeInstanceTest
// DisplayName: Testing/Graph/ImportTypeBeforeInstanceTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ImportTypeBeforeInstanceTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
