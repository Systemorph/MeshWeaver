// <meshweaver>
// Id: Testing/Graph/InFlightLastGoodBuildBindsTest
// DisplayName: Testing/Graph/InFlightLastGoodBuildBindsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class InFlightLastGoodBuildBindsTest
{
    ...
    [MeshTheory]
    [MeshInlineData(CompilationStatus.Pending)]
    [MeshInlineData(CompilationStatus.Compiling)]
...
/// </summary>
public class ForeignFrameworkStampOnTheMirrorTest(MeshTestContext context) : InMeshTestBase(output)
{
