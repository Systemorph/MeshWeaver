// <meshweaver>
// Id: Testing/Graph/InstanceLocationDeclarationValidatorTest
// DisplayName: Testing/Graph/InstanceLocationDeclarationValidatorTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class InstanceLocationDeclarationValidatorTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshTheory]
    [MeshInlineData("Role")]
    [MeshInlineData("GroupMembership")]
    [MeshInlineData("AccessAssignment")]
    [MeshInlineData("PartitionAccessPolicy")]
