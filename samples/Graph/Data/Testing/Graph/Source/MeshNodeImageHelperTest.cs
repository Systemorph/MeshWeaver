// <meshweaver>
// Id: Testing/Graph/MeshNodeImageHelperTest
// DisplayName: Testing/Graph/MeshNodeImageHelperTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
{
    [MeshTheory]
    [MeshInlineData("Document", null)]
    [MeshInlineData("People", null)]
    [MeshInlineData("/images/logo.png", "/images/logo.png")]
    [MeshInlineData("data:image/png;base64,abc", "data:image/png;base64,abc")]
    [MeshInlineData("https://example.com/img.png", "https://example.com/img.png")]
    [MeshInlineData("path/to/image.png", "path/to/image.png")]
    [MeshInlineData("", null)]
    [MeshInlineData(null, null)]
    ...
    [MeshTheory]
    [MeshInlineData("Markdown", "/static/NodeTypeIcons/document.svg")]
    [MeshInlineData("Code", "/static/NodeTypeIcons/code.svg")]
    [MeshInlineData("Agent", "/static/NodeTypeIcons/bot.svg")]
    [MeshInlineData("Skill", "/static/NodeTypeIcons/sparkle.svg")] // skill instances read as their NodeType (sparkle)
    [MeshInlineData("Thread", "/static/NodeTypeIcons/chat.svg")]
    [MeshInlineData("User", "/static/NodeTypeIcons/person.svg")]
    [MeshInlineData("Type/Code", "/static/NodeTypeIcons/code.svg")] // path form → matched on last segment
    [MeshInlineData("SomeCustomType", "/static/NodeTypeIcons/box.svg")] // unknown → neutral box, never a letter
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Sparkle", "/static/NodeTypeIcons/sparkle.svg")]
    [MeshInlineData("Presentation", "/static/NodeTypeIcons/presentation.svg")]
    [MeshInlineData("People", "/static/NodeTypeIcons/people.svg")]
    [MeshInlineData("Key", "/static/NodeTypeIcons/key.svg")]
    [MeshInlineData("Bot", "/static/NodeTypeIcons/bot.svg")]
    // The names skills use that had NO shipped glyph until now — each one was a generic sparkle.
    [MeshInlineData("Location", "/static/NodeTypeIcons/location.svg")]
    [MeshInlineData("LockClosed", "/static/NodeTypeIcons/lockclosed.svg")]
    [MeshInlineData("Layout", "/static/NodeTypeIcons/layout.svg")]
    [MeshInlineData("History", "/static/NodeTypeIcons/history.svg")]
    [MeshInlineData("DeviceMobile", "/static/NodeTypeIcons/devicemobile.svg")]
    [MeshInlineData("Add", "/static/NodeTypeIcons/add.svg")]
    [MeshInlineData("PuzzlePiece", "/static/NodeTypeIcons/puzzlepiece.svg")]
    [MeshInlineData("CloudArrowUp", "/static/NodeTypeIcons/cloudarrowup.svg")]
    [MeshInlineData("Bug", "/static/NodeTypeIcons/bug.svg")]
    ...
    [MeshTheory]
    [MeshInlineData("/static/NodeTypeIcons/code.svg")]
    [MeshInlineData("<svg viewBox=\"0 0 20 20\"></svg>")]
    [MeshInlineData("🧊")]
    [MeshInlineData(null)]
    [MeshInlineData("")]
    ...
    [MeshTheory]
    [MeshInlineData("book")]
    [MeshInlineData("target")]
    [MeshInlineData("library")]
    ...
    [MeshTheory]
    [MeshInlineData("/static/NodeTypeIcons/bot.svg")]
    [MeshInlineData("https://example.com/avatar.png")]
    [MeshInlineData("data:image/png;base64,abc")]
    ...
    [MeshInlineData(null, null)]
    [MeshInlineData("", "")]
    [MeshInlineData("NoSuchIconNameAtAll", "AlsoNotAnIcon")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("/static/NodeTypeIcons/document.svg", "image/svg+xml")]
    [MeshInlineData("/api/content/ACME/Space/content/logo.png", "image/png")]
    [MeshInlineData("/api/content/ACME/Space/content/logo.PNG", "image/png")]
    [MeshInlineData("/api/content/ACME/Space/content/cover.jpeg", "image/jpeg")]
    [MeshInlineData("https://example.com/mark.svg", "image/svg+xml")]
    [MeshInlineData("data:image/png;base64,abc", "image/png")]
    [MeshInlineData("/api/content/ACME/Space/content/logo.svg?v=3", "image/svg+xml")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("/api/content/ACME/Space/content/mark")]
    [MeshInlineData("/api/content/ACME/Space/content/mark.weird")]
    // A dotted DIRECTORY is not an extension — reading one as ".Space" would declare a made-up type.
    [MeshInlineData("/api/content/ACME/My.Space/content/mark")]
    ...
    [MeshTheory]
    [MeshInlineData("R&D", "R")]
    [MeshInlineData("hello", "h")]
    [MeshInlineData("👨‍👩‍👧‍👦", "👨‍👩‍👧‍👦")]
