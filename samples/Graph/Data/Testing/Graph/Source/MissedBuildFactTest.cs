// <meshweaver>
// Id: Testing/Graph/MissedBuildFactTest
// DisplayName: Testing/Graph/MissedBuildFactTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class MissedBuildFactTest
{
    ...
    [MeshTheory]
    [MeshInlineData(11, true)]   // a later run recorded the fact and ran the sync — this is history now
    [MeshInlineData(10, true)]   // the SAME run, recorded on a retry: exactly what was being held
    [MeshInlineData(9, false)]   // an older run says nothing about the gap
