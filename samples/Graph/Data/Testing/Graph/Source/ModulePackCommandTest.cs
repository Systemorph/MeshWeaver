// <meshweaver>
// Id: Testing/Graph/ModulePackCommandTest
// DisplayName: Testing/Graph/ModulePackCommandTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ModulePackCommandTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("--module-name", "../evil")]
    [MeshInlineData("--module-name", "a/b")]
    [MeshInlineData("--plugin", "..\\..\\escape")]
    [MeshInlineData("--package-version", "1.0.0/../../x")]
