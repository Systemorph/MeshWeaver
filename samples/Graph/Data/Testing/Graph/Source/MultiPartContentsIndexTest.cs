// <meshweaver>
// Id: Testing/Graph/MultiPartContentsIndexTest
// DisplayName: Testing/Graph/MultiPartContentsIndexTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
{
    [MeshTheory]
    [MeshInlineData(MeshSearchRenderMode.GraphNavigator)]   // the Search area's own default
    [MeshInlineData(MeshSearchRenderMode.Flat)]
    [MeshInlineData(MeshSearchRenderMode.Hierarchical)]
    [MeshInlineData(MeshSearchRenderMode.Grouped)]
