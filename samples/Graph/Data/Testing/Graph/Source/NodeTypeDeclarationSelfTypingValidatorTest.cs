// <meshweaver>
// Id: Testing/Graph/NodeTypeDeclarationSelfTypingValidatorTest
// DisplayName: Testing/Graph/NodeTypeDeclarationSelfTypingValidatorTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
