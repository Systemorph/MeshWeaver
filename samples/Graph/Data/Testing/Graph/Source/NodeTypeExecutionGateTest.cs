// <meshweaver>
// Id: Testing/Graph/NodeTypeExecutionGateTest
// DisplayName: Testing/Graph/NodeTypeExecutionGateTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class NodeTypeExecutionGateTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(NodeTypeEnrichmentHelpers.ExecutionRefusedSummaryKey)]
    [MeshInlineData(NodeTypeEnrichmentHelpers.ExecutionRefusedIntroKey)]
    [MeshInlineData(NodeTypeEnrichmentHelpers.ExecutionRefusedGuidanceKey)]
    [MeshInlineData(NodeTypeEnrichmentHelpers.NoCodeChangeNeededKey)]
