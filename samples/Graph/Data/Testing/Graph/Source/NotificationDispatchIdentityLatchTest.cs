// <meshweaver>
// Id: Testing/Graph/NotificationDispatchIdentityLatchTest
// DisplayName: Testing/Graph/NotificationDispatchIdentityLatchTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// assertion red.</para>
/// </summary>
public class NotificationDispatchIdentityLatchTest(MeshTestContext context) : InMeshTestBase(output)
{
