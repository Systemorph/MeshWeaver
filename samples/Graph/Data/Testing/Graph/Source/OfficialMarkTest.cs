// <meshweaver>
// Id: Testing/Graph/OfficialMarkTest
// DisplayName: Testing/Graph/OfficialMarkTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class OfficialMarkTest
{
    ...
    [MeshTheory]
    [MeshInlineData("<svg viewBox='0 0 24 24'><path d='M0 0h1v1H0z' data-mw-mark='official'/></svg>")]
    [MeshInlineData("<svg viewBox='0 0 24 24'><!-- data-mw-mark='official' --><path d='M0 0h1v1H0z'/></svg>")]
