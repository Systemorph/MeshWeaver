// <meshweaver>
// Id: Testing/Graph/PackageRootIconInheritanceTest
// DisplayName: Testing/Graph/PackageRootIconInheritanceTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PackageRootIconInheritanceTest
{
    ...
    [MeshTheory]
    [MeshInlineData("Chess/Rules", "Chess")]
    [MeshInlineData("Doc/Architecture/LinkPreviews", "Doc")]
    [MeshInlineData("AgenticEngineering/Lessons/01-TheMagicWish", "AgenticEngineering")]
    [MeshInlineData("/Chess/Rules", "Chess")] // leading separator tolerated
