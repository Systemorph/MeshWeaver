// <meshweaver>
// Id: Testing/Graph/PartitionNameRefusalTest
// DisplayName: Testing/Graph/PartitionNameRefusalTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class PartitionNameRefusalTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshTheory]
    [MeshInlineData("acme")]
    [MeshInlineData("acme-2.0_beta")]
    [MeshInlineData("müller")]          // letters are Unicode, not ASCII — an accented name is legitimate
    [MeshInlineData("7days")]           // may start with a digit
    ...
    [MeshTheory]
    [MeshInlineData("_Access")]         // a satellite container / global-satellite namespace, never a partition
    [MeshInlineData("-leading-dash")]
    [MeshInlineData("")]
