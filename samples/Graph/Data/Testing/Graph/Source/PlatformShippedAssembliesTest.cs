// <meshweaver>
// Id: Testing/Graph/PlatformShippedAssembliesTest
// DisplayName: Testing/Graph/PlatformShippedAssembliesTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PlatformShippedAssembliesTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("MeshWeaver", true)]
    [MeshInlineData("MeshWeaver.AI", true)]
    [MeshInlineData("meshweaver.ai", true)]
    [MeshInlineData("MeshWeaverish", false)]
    [MeshInlineData("Azure.Identity", false)]
