// <meshweaver>
// Id: Testing/Graph/PluginManifestCaretRangeTest
// DisplayName: Testing/Graph/PluginManifestCaretRangeTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PluginManifestCaretRangeTest
{
    ...
    [MeshInlineData("Store@^1.0.0", "[1.0.0,2.0.0)")]
    [MeshInlineData("Store@^1.2.3", "[1.2.3,2.0.0)")]
    [MeshInlineData("Store@^9.1.0", "[9.1.0,10.0.0)")]
    // 0.x: the MINOR is the breaking boundary — NOT 1.0.0.
    [MeshInlineData("Store@^0.2.3", "[0.2.3,0.3.0)")]
    [MeshInlineData("Store@^0.1.0", "[0.1.0,0.2.0)")]
    // 0.0.x: every PATCH may break, so the range admits exactly one version.
    [MeshInlineData("Store@^0.0.3", "[0.0.3,0.0.4)")]
