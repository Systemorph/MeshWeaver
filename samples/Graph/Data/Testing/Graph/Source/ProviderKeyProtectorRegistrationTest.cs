// <meshweaver>
// Id: Testing/Graph/ProviderKeyProtectorRegistrationTest
// DisplayName: Testing/Graph/ProviderKeyProtectorRegistrationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
