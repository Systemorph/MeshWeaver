// <meshweaver>
// Id: Testing/Graph/ReattemptBaseIsAuthoritativeTest
// DisplayName: Testing/Graph/ReattemptBaseIsAuthoritativeTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ReattemptBaseIsAuthoritativeTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("raises")]
    [MeshInlineData("emits null")]
    [MeshInlineData("ends empty")]
