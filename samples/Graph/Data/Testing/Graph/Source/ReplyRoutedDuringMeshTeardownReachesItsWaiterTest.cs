// <meshweaver>
// Id: Testing/Graph/ReplyRoutedDuringMeshTeardownReachesItsWaiterTest
// DisplayName: Testing/Graph/ReplyRoutedDuringMeshTeardownReachesItsWaiterTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// not a clock.</para>
/// </summary>
public class ReplyRoutedDuringMeshTeardownReachesItsWaiterTest(MeshTestContext context)
    : InMeshTestBase(output)
{
    ...
    private async Task ParkTheWaiterAndTearDownTheMesh(IMessageHub waiter, AsyncSubject<Unit> turnEntered)
    {
        ...
        await Observable.Interval(25.Milliseconds()).StartWith(0L)
            ...
            .FirstAsync().Timeout(TestTimeouts.Convergence).Await(CancellationToken.None);
