// <meshweaver>
// Id: Testing/Graph/StaleMainNodeRepairTest
// DisplayName: Testing/Graph/StaleMainNodeRepairTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class StaleMainNodeRepairTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    /// below each <c>[MeshFact(Timeout = …)]</c> above, so a wedge is reported as the assertion that did
