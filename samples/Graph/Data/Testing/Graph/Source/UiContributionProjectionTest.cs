// <meshweaver>
// Id: Testing/Graph/UiContributionProjectionTest
// DisplayName: Testing/Graph/UiContributionProjectionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class UiContributionProjectionTest
{
    ...
    [MeshInlineData("//evil.example/phish")]
    [MeshInlineData("data:text/html,x")]
