// <meshweaver>
// Id: Testing/Hosting/ABakeCompilesTheDefinitionItResolvedTest
// DisplayName: Testing/Hosting/ABakeCompilesTheDefinitionItResolvedTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ABakeCompilesTheDefinitionItResolvedTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshInlineData(CallsTheSharedFile, PreWarmStatus.Compiled)]
    [MeshInlineData(CallsWhatNothingDeclares, PreWarmStatus.CompileError)]
