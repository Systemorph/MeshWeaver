// <meshweaver>
// Id: Testing/Hosting/ARetiredNodeTypeIsNotARegressionTest
// DisplayName: Testing/Hosting/ARetiredNodeTypeIsNotARegressionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ARetiredNodeTypeIsNotARegressionTest(MeshTestContext context) : InMeshTestBase(output)
{
    // ——— the gate: Retired / Removed do not gate; a standing regression can be withdrawn ————

    [MeshTheory(TimeoutSeconds = 60)]
    [MeshInlineData(PreWarmStatus.Retired)]
    [MeshInlineData(PreWarmStatus.Removed)]
