// <meshweaver>
// Id: Testing/Hosting/AbortedStartupSkipsOrderedShutdownTest
// DisplayName: Testing/Hosting/AbortedStartupSkipsOrderedShutdownTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class AbortedStartupSkipsOrderedShutdownTest
{
    ...
    public async Task AnAbortedStartup_DisposesTheContainer_WithoutRunningAnyStopAsync()
    {
        ...
        var thrown = await Record.ExceptionAsync(() => host.StartAsync(CancellationToken.None));
