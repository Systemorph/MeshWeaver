// <meshweaver>
// Id: Testing/Hosting/AsyncDisposeQueueTest
// DisplayName: Testing/Hosting/AsyncDisposeQueueTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class AsyncDisposeQueueTest
{
    ...
    public async Task DrainAsync_cancels_a_wedged_cleanup_then_joins_within_budget()
    {
        ...
        await entered.Task.WaitAsync(Quiesce, CancellationToken.None);
