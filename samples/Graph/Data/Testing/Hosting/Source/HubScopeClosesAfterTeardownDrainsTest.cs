// <meshweaver>
// Id: Testing/Hosting/HubScopeClosesAfterTeardownDrainsTest
// DisplayName: Testing/Hosting/HubScopeClosesAfterTeardownDrainsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class HubScopeClosesAfterTeardownDrainsTest : InMeshTestBase
{
    ...
    public HubScopeClosesAfterTeardownDrainsTest(MeshTestContext context) : base(context)
    {
