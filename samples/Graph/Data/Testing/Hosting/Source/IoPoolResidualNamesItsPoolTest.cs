// <meshweaver>
// Id: Testing/Hosting/IoPoolResidualNamesItsPoolTest
// DisplayName: Testing/Hosting/IoPoolResidualNamesItsPoolTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class IoPoolResidualNamesItsPoolTest
{
    ...
    public async Task DrainAll_reportsTheResidual_againstTheNameOfThePoolThatLeaked()
    {
        ...
        await entered.Timeout(TimeSpan.FromSeconds(10)).Await(CancellationToken.None);
