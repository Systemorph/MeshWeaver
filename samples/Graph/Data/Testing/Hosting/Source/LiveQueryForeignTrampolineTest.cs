// <meshweaver>
// Id: Testing/Hosting/LiveQueryForeignTrampolineTest
// DisplayName: Testing/Hosting/LiveQueryForeignTrampolineTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class LiveQueryForeignTrampolineTest
{
    ...
    [MeshTheory]
    [MeshInlineData("path:probe/_Usage scope:children")]
    [MeshInlineData("path:probe/_Usage scope:subtree")]
    [MeshInlineData("path:probe/_Usage scope:descendants")]
    [MeshInlineData("path:probe/_Usage/one scope:exact")]
