// <meshweaver>
// Id: Testing/Hosting/MeshAdmissionIsNeverMorePermissiveThanReadinessTest
// DisplayName: Testing/Hosting/MeshAdmissionIsNeverMorePermissiveThanReadinessTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class MeshAdmissionIsNeverMorePermissiveThanReadinessTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(BakePhase.Faulted, true, MeshAdmission.Admitted)]
    [MeshInlineData(BakePhase.Faulted, false, MeshAdmission.Refused)]
    [MeshInlineData(BakePhase.Regressed, true, MeshAdmission.Refused)]
    [MeshInlineData(BakePhase.Regressed, false, MeshAdmission.Refused)]
