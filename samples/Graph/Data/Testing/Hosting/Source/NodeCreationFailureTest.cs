// <meshweaver>
// Id: Testing/Hosting/NodeCreationFailureTest
// DisplayName: Testing/Hosting/NodeCreationFailureTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class NodeCreationFailureTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Node already exists: Some/Path")]
    [MeshInlineData("Node already exists at path: Some/Path")]
