// <meshweaver>
// Id: Testing/Hosting/OwnerAnswerRecognitionGuard
// DisplayName: Testing/Hosting/OwnerAnswerRecognitionGuard — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class OwnerAnswerRecognitionGuard(MeshTestContext context)
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("No node found at 'TestData/silent-read' — the node was deleted, so this address "
                + "will not reactivate.", "a routing NotFound is a provable ABSENCE, not a recycling owner")]
    [MeshInlineData("No route to 'TestData/silent-read'",
        "a bare routing failure promises no retry and names no owner")]
    [MeshInlineData("Mesh is shutting down, cannot route to TestData/silent-read",
    ...
    [MeshInlineData("Host is shutting down, cannot route to TestData/silent-read",
    ...
    [MeshInlineData("Hub TestData/silent-read/child is shutting down; retry to get the authoritative answer.",
        "a DIFFERENT hub's recycle is not this owner answering")]
    [MeshInlineData("Hub TestData/silent-rea is shutting down — cannot process GetDataRequest.",
