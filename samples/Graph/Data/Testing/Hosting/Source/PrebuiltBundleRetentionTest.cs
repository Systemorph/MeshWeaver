// <meshweaver>
// Id: Testing/Hosting/PrebuiltBundleRetentionTest
// DisplayName: Testing/Hosting/PrebuiltBundleRetentionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PrebuiltBundleRetentionTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("memex-portal-ai:3.0.0-ci.8080", "3.0.0-ci.8080")]
    [MeshInlineData("meshweaver.azurecr.io/memex-portal-ai:3.0.0-ci.8080@sha256:abc", "3.0.0-ci.8080")]
    [MeshInlineData("3.1.0+deadbeef", "3.1.0")]
    [MeshInlineData("  ", null)]
    ...
    [MeshTheory]
    [MeshInlineData("3.1.0-ci.8076", "3.1.0", true)]
    [MeshInlineData("3.1.0", "3.1.0", false)]
    [MeshInlineData("3.1.0+abc123", "3.1.0", false)]
    [MeshInlineData("3.0.0-rc9", "3.0.0", true)]
    [MeshInlineData("garbage", null, false)]
    ...
    [MeshTheory]
    [MeshInlineData("00:00:00", 30)]
    [MeshInlineData("1.00:00:00", 30)]
