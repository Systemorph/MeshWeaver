// <meshweaver>
// Id: Testing/Hosting/RecycledHubRefusalTest
// DisplayName: Testing/Hosting/RecycledHubRefusalTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class RecycledHubRefusalTest : InMeshTestBase
{
    private readonly ITestOutputHelper output;

    public RecycledHubRefusalTest(MeshTestContext context) : base(context) => this.output = output;
