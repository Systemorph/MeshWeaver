// <meshweaver>
// Id: Testing/Hosting/SeedingSurvivesASealRemovedMidReadTest
// DisplayName: Testing/Hosting/SeedingSurvivesASealRemovedMidReadTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class SeedingSurvivesASealRemovedMidReadTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData(false)] // the seal alone is removed  -> FileNotFoundException before the fix
    [MeshInlineData(true)]  // its directory goes with it -> DirectoryNotFoundException before the fix
