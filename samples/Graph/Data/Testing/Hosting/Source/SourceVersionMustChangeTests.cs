// <meshweaver>
// Id: Testing/Hosting/SourceVersionMustChangeTests
// DisplayName: Testing/Hosting/SourceVersionMustChangeTests — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class SourceVersionMustChangeTests
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(0)]      // default(DateTimeOffset)
    [MeshInlineData(1601)]   // FileInfo.LastWriteTimeUtc for a file that is not there
