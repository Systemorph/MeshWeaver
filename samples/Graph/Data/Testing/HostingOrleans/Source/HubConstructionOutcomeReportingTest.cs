// <meshweaver>
// Id: Testing/HostingOrleans/HubConstructionOutcomeReportingTest
// DisplayName: Testing/HostingOrleans/HubConstructionOutcomeReportingTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class HubConstructionOutcomeReportingTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(HostedHubOutcome.Unclassified)]
    [MeshInlineData(HostedHubOutcome.Available)]
    [MeshInlineData(HostedHubOutcome.Absent)]
