// <meshweaver>
// Id: Testing/HostingOrleans/IoPoolSiloTeardownTest
// DisplayName: Testing/HostingOrleans/IoPoolSiloTeardownTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class IoPoolSiloTeardownTest
{
    ...
    public async Task Stop_JoinsPooledIo_EvenAfterTheContainerHasBeenDisposed()
    {
        ...
        Func<Task> stop = () => observer.OnStop(CancellationToken.None);
