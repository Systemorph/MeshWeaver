// <meshweaver>
// Id: Testing/HostingOrleans/OrleansAssemblyStoreTest
// DisplayName: Testing/HostingOrleans/OrleansAssemblyStoreTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class OrleansAssemblyStoreTest(MeshTestContext context) : OrleansMeshTestBase(output)
{
    /// <inheritdoc />
