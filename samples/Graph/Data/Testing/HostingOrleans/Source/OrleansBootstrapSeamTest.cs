// <meshweaver>
// Id: Testing/HostingOrleans/OrleansBootstrapSeamTest
// DisplayName: Testing/HostingOrleans/OrleansBootstrapSeamTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class OrleansBootstrapSeamTest(MeshTestContext context)
{
    /// <summary>
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(ClusterProvider.AdoNet, StorageProvider.Memory)]
    [MeshInlineData(ClusterProvider.Redis, StorageProvider.Memory)]
    [MeshInlineData(ClusterProvider.Localhost, StorageProvider.AdoNet)]
    [MeshInlineData(ClusterProvider.Localhost, StorageProvider.Redis)]
    ...
    private sealed class WronglyBootstrappedSuite(MeshTestContext context) : OrleansMeshTestBase(output)
    {
