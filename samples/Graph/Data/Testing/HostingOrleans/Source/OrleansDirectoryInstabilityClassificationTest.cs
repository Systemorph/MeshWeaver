// <meshweaver>
// Id: Testing/HostingOrleans/OrleansDirectoryInstabilityClassificationTest
// DisplayName: Testing/HostingOrleans/OrleansDirectoryInstabilityClassificationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class OrleansDirectoryInstabilityClassificationTest
{
    ...
    [MeshTheory]
    [MeshInlineData(HopLimitText)]
    [MeshInlineData(NotStableText)]
    [MeshInlineData(InvalidSiloRegistrationText)]
