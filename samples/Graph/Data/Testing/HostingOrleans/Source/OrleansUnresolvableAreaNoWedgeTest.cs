// <meshweaver>
// Id: Testing/HostingOrleans/OrleansUnresolvableAreaNoWedgeTest
// DisplayName: Testing/HostingOrleans/OrleansUnresolvableAreaNoWedgeTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class OrleansUnresolvableAreaNoWedgeTest(MeshTestContext context) : OrleansMeshTestBase(output)
{
    /// <summary>
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("area:Search")]   // the legacy colon form — the exact home/Space embed wedge shape
    [MeshInlineData("area:Pinned")]
    [MeshInlineData("NoSuchArea_xyz")] // plain non-existent area — baseline (no colon)
