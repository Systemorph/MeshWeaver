// <meshweaver>
// Id: Testing/HostingOrleans/RoutedFailureClassificationTest
// DisplayName: Testing/HostingOrleans/RoutedFailureClassificationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
{
    [MeshTheory]
    [MeshInlineData("Hub is shutting down")]
    [MeshInlineData("Hub app/Kernel is shutting down (RunLevel=DisposeHostedHubs) — cannot process "
    ...
    [MeshTheory]
    [MeshInlineData("No node found at 'Doc/Missing'")]
    [MeshInlineData("Delivery failed to app/Thing")]
    [MeshInlineData("Validation failed: name is required")]
