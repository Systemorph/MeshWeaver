// <meshweaver>
// Id: Testing/HostingOrleans/RoutingQuiescenceTest
// DisplayName: Testing/HostingOrleans/RoutingQuiescenceTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class RoutingQuiescenceTest
{
    ...
    public async Task SiloStop_HoldsBeforeGrainDeactivation_UntilTheRoutingWorkHasLanded()
    {
        ...
        var stop = lifecycle.OnStop(CancellationToken.None);
    ...
    public async Task SiloStop_WithNothingInFlight_DoesNotHold()
    {
        ...
        await lifecycle.OnStop(CancellationToken.None).WaitAsync(Bound);
    ...
    public async Task SiloStop_BudgetExpiry_ReleasesTheSilo_AndNamesTheResidual()
    {
        ...
        await ((ILifecycleObserver)participant).OnStop(CancellationToken.None).WaitAsync(Bound);
