// <meshweaver>
// Id: Testing/HostingOrleans/SiloShutdownActivationGateTest
// DisplayName: Testing/HostingOrleans/SiloShutdownActivationGateTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class SiloShutdownActivationGateTest : InMeshTestBase
{
    ...
    public SiloShutdownActivationGateTest(MeshTestContext context) : base(context)
    {
