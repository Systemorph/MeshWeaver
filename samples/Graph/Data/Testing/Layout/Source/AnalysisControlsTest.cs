// <meshweaver>
// Id: Testing/Layout/AnalysisControlsTest
// DisplayName: Testing/Layout/AnalysisControlsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class AnalysisControlsTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <inheritdoc />
    ...
    [MeshTheory]
    [MeshInlineData("Acme/Deal/Layer1", "/Acme/Deal/Layer1")]
    [MeshInlineData("/Acme/Deal/Layer1", "/Acme/Deal/Layer1")]
    [MeshInlineData("https://example.com/x", "https://example.com/x")]
    [MeshInlineData("  Acme/Deal  ", "/Acme/Deal")]
