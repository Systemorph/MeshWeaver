// <meshweaver>
// Id: Testing/Layout/AreaIdEncodingTest
// DisplayName: Testing/Layout/AreaIdEncodingTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
{
    [MeshTheory]
    [MeshInlineData("Chess/GambitHunt/Source/GambitHunt")]
    [MeshInlineData("plain")]
    [MeshInlineData("with.dot")]
    [MeshInlineData("path/with.dot/and/slashes.cs")]
