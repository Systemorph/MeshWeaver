// <meshweaver>
// Id: Testing/Layout/CatalogActionIdentityTest
// DisplayName: Testing/Layout/CatalogActionIdentityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class CatalogActionIdentityTest : InMeshTestBase
{
    private const string Area = "CatalogActions";
    private readonly AsyncSubject<LayoutAreaHost> owner = new();

    public CatalogActionIdentityTest(MeshTestContext context) : base(context)
    ...
    [MeshTheory]
    [MeshInlineData(false, "same")]
    [MeshInlineData(false, "insert")]
    [MeshInlineData(false, "rename")]
    [MeshInlineData(false, "description")]
    [MeshInlineData(false, "slash")]
    [MeshInlineData(true, "same")]
    [MeshInlineData(true, "insert")]
    [MeshInlineData(true, "rename")]
    [MeshInlineData(true, "description")]
    [MeshInlineData(true, "slash")]
