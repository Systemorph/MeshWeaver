// <meshweaver>
// Id: Testing/Layout/DroppedUserActionIsRefusedTest
// DisplayName: Testing/Layout/DroppedUserActionIsRefusedTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DroppedUserActionIsRefusedTest : InMeshTestBase
{
    ...
    /// <inheritdoc />
    public DroppedUserActionIsRefusedTest(MeshTestContext context) : base(context)
    {
