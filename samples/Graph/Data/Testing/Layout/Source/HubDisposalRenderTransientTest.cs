// <meshweaver>
// Id: Testing/Layout/HubDisposalRenderTransientTest
// DisplayName: Testing/Layout/HubDisposalRenderTransientTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class HubDisposalRenderTransientTest : InMeshTestBase
{
    ...
    public HubDisposalRenderTransientTest(MeshTestContext context) : base(context)
    {
