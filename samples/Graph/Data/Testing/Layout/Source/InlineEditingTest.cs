// <meshweaver>
// Id: Testing/Layout/InlineEditingTest
// DisplayName: Testing/Layout/InlineEditingTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class InlineEditingTest(MeshTestContext context) : InMeshTestBase(output)
{
    #region Test Domain
...
/// </summary>
public class InlineEditingPersistenceTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <summary>
    ...
    private void SetupAutoSave(LayoutAreaHost host, string dataId, PersistedContent originalItem)
    {
        ...
        // on every workspace emission — and the test service provider outlives the [MeshFact]
...
/// </summary>
public class ObjectTypeAutoSaveTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    private void SetupAutoSaveWithObjectType(LayoutAreaHost host, string dataId, TestItem originalItem)
    {
        ...
        // and the test service provider outlives the [MeshFact] — so these callbacks fire after the
