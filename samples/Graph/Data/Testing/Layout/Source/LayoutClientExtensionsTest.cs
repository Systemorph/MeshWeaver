// <meshweaver>
// Id: Testing/Layout/LayoutClientExtensionsTest
// DisplayName: Testing/Layout/LayoutClientExtensionsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class LayoutClientExtensionsTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("\"hello\"", "hello")]              // a JSON string reads as its text, not its quoting
    [MeshInlineData("{\"a\":1}", "{\"a\":1}")]            // a structured value in a scalar slot shows what it was given
    [MeshInlineData("[1,2]", "1, 2")]        // an array already had a reading; it renders its members
