// <meshweaver>
// Id: Testing/Layout/LayoutTest
// DisplayName: Testing/Layout/LayoutTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DefaultAreaTest(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class CodeEditorDataBindingTest(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class DefaultAreaConventionTest(MeshTestContext context) : InMeshTestBase(output)
{
