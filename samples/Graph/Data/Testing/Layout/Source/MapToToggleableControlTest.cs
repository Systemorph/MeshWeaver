// <meshweaver>
// Id: Testing/Layout/MapToToggleableControlTest
// DisplayName: Testing/Layout/MapToToggleableControlTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class MapToToggleableControlTest(MeshTestContext context) : InMeshTestBase(output)
{
    #region Test Domain
...
/// </summary>
public class EditPersistenceTest(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class MarkdownToggleTest(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class ReadonlyNumericRenderingTest(MeshTestContext context) : InMeshTestBase(output)
{
