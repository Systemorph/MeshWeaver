// <meshweaver>
// Id: Testing/Layout/MeshNodeBindingExtensionsTest
// DisplayName: Testing/Layout/MeshNodeBindingExtensionsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class MeshNodeBindingExtensionsTest
{
    ...
    [MeshTheory]
    [MeshInlineData("courses/2/notes")]   // out of range
    [MeshInlineData("courses/-1/notes")]  // negative
    [MeshInlineData("courses/x/notes")]   // not an index
