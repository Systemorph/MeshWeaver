// <meshweaver>
// Id: Testing/Layout/NavigateToSidePanelTest
// DisplayName: Testing/Layout/NavigateToSidePanelTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class NavigateToSidePanelTest(MeshTestContext context) : InMeshTestBase(output)
{
