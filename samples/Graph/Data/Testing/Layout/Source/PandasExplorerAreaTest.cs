// <meshweaver>
// Id: Testing/Layout/PandasExplorerAreaTest
// DisplayName: Testing/Layout/PandasExplorerAreaTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class PandasExplorerAreaTest : InMeshTestBase
{
    private const string Area = PandasExplorerLayoutAreas.ExplorerArea;

    public PandasExplorerAreaTest(MeshTestContext context) : base(context)
    {
...
/// </summary>
public class PandasExplorerNoParticipantTest(MeshTestContext context) : InMeshTestBase(output)
{
    private const string Area = PandasExplorerLayoutAreas.ExplorerArea;
