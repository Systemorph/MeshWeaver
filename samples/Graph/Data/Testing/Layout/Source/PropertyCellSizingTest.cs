// <meshweaver>
// Id: Testing/Layout/PropertyCellSizingTest
// DisplayName: Testing/Layout/PropertyCellSizingTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PropertyCellSizingTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.Id))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.Notes))]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.Count))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.Status))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.DueDate))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.IsActive))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.DimensionRef))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.NodeRef))]
    [MeshInlineData(nameof(PropertyCellSizingDomain.SizingEntity.Size))]
...
/// </summary>
public class PropertyFormCellSizingRenderTest(MeshTestContext context) : InMeshTestBase(output)
{
