// <meshweaver>
// Id: Testing/Layout/RenderFailureDiagnosticsTest
// DisplayName: Testing/Layout/RenderFailureDiagnosticsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class RenderFailureDiagnosticsTest : InMeshTestBase
{
    ...
    public RenderFailureDiagnosticsTest(MeshTestContext context) : base(context)
    {
