// <meshweaver>
// Id: Testing/Layout/SlideShowControlTest
// DisplayName: Testing/Layout/SlideShowControlTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class SlideShowControlTest(MeshTestContext context) : InMeshTestBase(output)
{
    /// <inheritdoc />
