// <meshweaver>
// Id: Testing/Layout/SubscribeDuringRecycleTest
// DisplayName: Testing/Layout/SubscribeDuringRecycleTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class SubscribeDuringRecycleTest(MeshTestContext context) : InMeshTestBase(output)
{
        ...
        IMessageHub host, AsyncSubject<Unit>? blockerEntered, Func<bool>? release)
    {
        ...
        await area!.Started.WaitAsync(TimeSpan.FromSeconds(30), CancellationToken.None);
        return area;
    }
