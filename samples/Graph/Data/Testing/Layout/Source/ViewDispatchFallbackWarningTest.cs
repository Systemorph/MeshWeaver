// <meshweaver>
// Id: Testing/Layout/ViewDispatchFallbackWarningTest
// DisplayName: Testing/Layout/ViewDispatchFallbackWarningTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// dead logger.</para>
/// </summary>
public class ViewDispatchFallbackWarningTest : InMeshTestBase
{
    private readonly ConcurrentQueue<(string Category, LogLevel Level, string Message)> logRecords = new();

    /// <inheritdoc />
    public ViewDispatchFallbackWarningTest(MeshTestContext context) : base(context)
    {
