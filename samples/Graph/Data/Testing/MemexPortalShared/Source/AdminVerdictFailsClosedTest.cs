// <meshweaver>
// Id: Testing/MemexPortalShared/AdminVerdictFailsClosedTest
// DisplayName: Testing/MemexPortalShared/AdminVerdictFailsClosedTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class AdminVerdictFailsClosedTest
{
    ...
    private async Task<bool> Resolve(IObservable<bool> source)
    {
        var verdict = await AdminVerdict
            ...
            .ObserveCompletion(ex => lateFault = ex, CancellationToken.None);
