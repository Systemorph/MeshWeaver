// <meshweaver>
// Id: Testing/MemexPortalShared/ApiTokenBasicAuthTest
// DisplayName: Testing/MemexPortalShared/ApiTokenBasicAuthTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ApiTokenBasicAuthTest
{
    ...
    [MeshTheory]
    [MeshInlineData("Bearer mw_abc", "mw_abc")]
    [MeshInlineData("bearer mw_abc", "mw_abc")]                  // scheme is case-insensitive
    [MeshInlineData("  Bearer   mw_abc  ", "mw_abc")]            // stray whitespace tolerated
    ...
    [MeshTheory]
    [MeshInlineData("nuget")]
    [MeshInlineData("anything")]
    [MeshInlineData("")]
    ...
    [MeshInlineData("")]
    [MeshInlineData("   ")]
    [MeshInlineData("mw_abc")]                                   // no scheme
    [MeshInlineData("Bearer ")]
    [MeshInlineData("Basic ")]
    [MeshInlineData("Basic !!!not-base64!!!")]
    [MeshInlineData("Negotiate abc")]                            // unrelated scheme
