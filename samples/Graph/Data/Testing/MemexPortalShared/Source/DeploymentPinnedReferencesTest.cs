// <meshweaver>
// Id: Testing/MemexPortalShared/DeploymentPinnedReferencesTest
// DisplayName: Testing/MemexPortalShared/DeploymentPinnedReferencesTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class DeploymentPinnedReferencesTest
{
    ...
    [MeshTheory]
    [MeshInlineData("""{"frameworkIdentity":"s-current"}""")]
    [MeshInlineData("""{"frameworkIdentity":"s-current","adoptedFrameworkInventoryComplete":false,"adoptedFrameworkIdentities":[]}""")]
    [MeshInlineData("""{"frameworkIdentity":"s-current","adoptedFrameworkInventoryComplete":true}""")]
    [MeshInlineData("""{"frameworkIdentity":"s-current","adoptedFrameworkInventoryComplete":true,"adoptedFrameworkIdentities":[null]}""")]
    [MeshInlineData("""{"frameworkIdentity":"s-current","adoptedFrameworkInventoryComplete":true,"adoptedFrameworkIdentities":[""]}""")]
    [MeshInlineData("""{"adoptedFrameworkInventoryComplete":true,"adoptedFrameworkIdentities":[]}""")]
