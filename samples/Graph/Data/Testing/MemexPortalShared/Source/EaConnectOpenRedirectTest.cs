// <meshweaver>
// Id: Testing/MemexPortalShared/EaConnectOpenRedirectTest
// DisplayName: Testing/MemexPortalShared/EaConnectOpenRedirectTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class EaConnectOpenRedirectTest
{
    ...
    [MeshTheory]
    [MeshInlineData("https://phish.example")]          // absolute, the headline case
    [MeshInlineData("http://phish.example/steal")]
    [MeshInlineData("//phish.example")]                // protocol-relative — a leading '/' is not enough
    [MeshInlineData("//phish.example/path?a=b")]
    [MeshInlineData("/\\phish.example")]               // backslash variant some browsers normalise
    [MeshInlineData("javascript:alert(1)")]            // not a navigation target at all
    [MeshInlineData("mailto:a@b.example")]
    [MeshInlineData("rbuergi")]                        // not rooted — ambiguous, so refused
    ...
    [MeshInlineData("/rbuergi/Chat?from=ea#top")]
    [MeshInlineData("/")]
