// <meshweaver>
// Id: Testing/MemexPortalShared/EmailMisconfigurationRefusalTest
// DisplayName: Testing/MemexPortalShared/EmailMisconfigurationRefusalTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class EmailMisconfigurationRefusalTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(false, "t", "c", "s", 0)]              // client secret, complete
    [MeshInlineData(false, "", "c", "s", 1)]               // 🚨 the incident: tenant id unset
    [MeshInlineData(false, "  ", "c", "s", 1)]             // whitespace is not a tenant id
    [MeshInlineData(false, "", "", "", 3)]                 // nothing configured at all
    [MeshInlineData(true, "", "", "", 0)]                  // managed identity needs no keys
