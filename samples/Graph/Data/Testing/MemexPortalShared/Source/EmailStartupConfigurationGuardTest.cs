// <meshweaver>
// Id: Testing/MemexPortalShared/EmailStartupConfigurationGuardTest
// DisplayName: Testing/MemexPortalShared/EmailStartupConfigurationGuardTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class EmailStartupConfigurationGuardTest
{
    ...
    [MeshTheory]
    [MeshInlineData("", "", "", "")]
    [MeshInlineData("memex@example.test", "", "", "secret")]
    [MeshInlineData("memex@example.test", "tenant", "client", "secret")]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Email:MailboxAddress")]
    [MeshInlineData("Email:TenantId")]
    [MeshInlineData("Email:ClientId")]
    [MeshInlineData("Email:ClientSecret")]
    ...
    [MeshTheory]
    [MeshInlineData("Email:TenantId", "Email__TenantId")]
    [MeshInlineData("Email:Enabled", "Email__Enabled")]
    [MeshInlineData("Email:MailboxAddress", "Email__MailboxAddress")]
    ...
    [MeshTheory]
    [MeshInlineData(false, "", "", "")]
    [MeshInlineData(false, "t", "", "s")]
    [MeshInlineData(false, "t", "c", "s")]
    [MeshInlineData(true, "", "", "")]
