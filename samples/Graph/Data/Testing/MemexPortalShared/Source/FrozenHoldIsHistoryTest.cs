// <meshweaver>
// Id: Testing/MemexPortalShared/FrozenHoldIsHistoryTest
// DisplayName: Testing/MemexPortalShared/FrozenHoldIsHistoryTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class FrozenHoldIsHistoryTest
{
    ...
    [MeshTheory]
    [MeshInlineData(UpdatePolicyKind.Continuous)]
    [MeshInlineData(UpdatePolicyKind.Stable)]
