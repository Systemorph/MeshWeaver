// <meshweaver>
// Id: Testing/MemexPortalShared/IconRasterizerTest
// DisplayName: Testing/MemexPortalShared/IconRasterizerTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class IconRasterizerTest
{
    ...
    [MeshInlineData("")]
    [MeshInlineData("   ")]
    [MeshInlineData("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 0 0'></svg>")]
    [MeshInlineData("<svg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 24 24'></svg>")]
    [MeshInlineData("<svg></svg>")]
