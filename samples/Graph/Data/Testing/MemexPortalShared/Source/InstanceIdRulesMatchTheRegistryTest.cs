// <meshweaver>
// Id: Testing/MemexPortalShared/InstanceIdRulesMatchTheRegistryTest
// DisplayName: Testing/MemexPortalShared/InstanceIdRulesMatchTheRegistryTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
