// <meshweaver>
// Id: Testing/MemexPortalShared/McpRoutingTest
// DisplayName: Testing/MemexPortalShared/McpRoutingTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class McpRoutingTest
{
    ...
    [MeshTheory]
    [MeshInlineData("/mcp")]        // the compatibility alias every existing client config uses
    [MeshInlineData("/api/mcp")]    // the primary path — rewritten onto the module's route
    [MeshInlineData("/API/MCP")]    // route matching is case-insensitive; the rewrite must be too
    ...
    [MeshTheory]
    [MeshInlineData("text/event-stream")]                    // streamable-HTTP SSE channel probe
    [MeshInlineData("application/json, text/event-stream")]  // API-shaped read
    ...
    [MeshTheory]
    [MeshInlineData("/.well-known/oauth-protected-resource/api/mcp", "/api/mcp")]
    [MeshInlineData("/.well-known/oauth-protected-resource/mcp", "/mcp")]
    [MeshInlineData("/.well-known/oauth-protected-resource", "(bare)")]
