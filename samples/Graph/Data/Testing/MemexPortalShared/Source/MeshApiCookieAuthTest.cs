// <meshweaver>
// Id: Testing/MemexPortalShared/MeshApiCookieAuthTest
// DisplayName: Testing/MemexPortalShared/MeshApiCookieAuthTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class MeshApiCookieAuthTest
{
    ...
    {
        var response = await client.GetAsync(SignInRoute, CancellationToken.None);
