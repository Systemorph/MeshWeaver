// <meshweaver>
// Id: Testing/MemexPortalShared/MicrosoftTenantAuthorityTest
// DisplayName: Testing/MemexPortalShared/MicrosoftTenantAuthorityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class MicrosoftTenantAuthorityTest
{
    ...
    [MeshTheory]
    [MeshInlineData("organizations", "https://login.microsoftonline.com/organizations/v2.0")]
    [MeshInlineData(" organizations ", "https://login.microsoftonline.com/organizations/v2.0")]
    [MeshInlineData("consumers", "https://login.microsoftonline.com/consumers/v2.0")]
    [MeshInlineData("contoso.onmicrosoft.com", "https://login.microsoftonline.com/contoso.onmicrosoft.com/v2.0")]
    [MeshInlineData("72f988bf-86f1-41af-91ab-2d7cd011db47",
    ...
    [MeshInlineData("/")]
    [MeshInlineData("a/b")]
    [MeshInlineData("my tenant")]
    [MeshInlineData("../common")]
    [MeshInlineData("organizations?x=1")]
    [MeshInlineData("login.microsoftonline.com/organizations")]
