// <meshweaver>
// Id: Testing/MemexPortalShared/ModulePlatformLinkTest
// DisplayName: Testing/MemexPortalShared/ModulePlatformLinkTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ModulePlatformLinkTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("1.0.0.0", "9.0.0.0")]
    [MeshInlineData("1.0.0.0", "1.0.0.0")]
    ...
    [MeshTheory]
    [MeshInlineData("public int Answer() => 42; public int Answer(int extra) => extra;", true)]
    [MeshInlineData("public long Answer() => 42;", false)]
    [MeshInlineData("public int Answer(int extra) => extra;", false)]
