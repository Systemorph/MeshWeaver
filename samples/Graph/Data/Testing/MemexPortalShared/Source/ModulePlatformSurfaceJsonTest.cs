// <meshweaver>
// Id: Testing/MemexPortalShared/ModulePlatformSurfaceJsonTest
// DisplayName: Testing/MemexPortalShared/ModulePlatformSurfaceJsonTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ModulePlatformSurfaceJsonTest
{
    ...
    [MeshInlineData("{}")]
    [MeshInlineData("[]")]
    [MeshInlineData("""{"identity":"x"}""")]
    [MeshInlineData("""{"identity":"x","assemblies":{}}""")]
    [MeshInlineData("""{"identity":"x","assemblies":{"A":"not-an-array"}}""")]
    [MeshInlineData("""{"identity":"x","assemblies":{"A":[1,2]}}""")]
    [MeshInlineData("not json at all")]
