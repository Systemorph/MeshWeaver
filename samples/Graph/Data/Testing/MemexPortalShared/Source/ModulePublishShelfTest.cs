// <meshweaver>
// Id: Testing/MemexPortalShared/ModulePublishShelfTest
// DisplayName: Testing/MemexPortalShared/ModulePublishShelfTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ModulePublishShelfTest : IDisposable
{
    ...
    [MeshInlineData("1.6.1", "1.7.0", true)]
    [MeshInlineData("1.7.0-rc1", "1.7.0", true)]            // the stable outranks the pre-release it follows
    [MeshInlineData("3.0.0-ci.900", "3.0.0-ci.3758", true)] // numeric identifiers, not text
    // second is shelf-only
    [MeshInlineData("1.7.0", "1.6.1", false)]
    [MeshInlineData("1.7.0", "1.7.0-rc1", false)]           // a pre-release published after its stable
    [MeshInlineData("3.0.0-ci.3758", "3.0.0-ci.900", false)]
