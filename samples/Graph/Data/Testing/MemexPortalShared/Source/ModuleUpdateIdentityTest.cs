// <meshweaver>
// Id: Testing/MemexPortalShared/ModuleUpdateIdentityTest
// DisplayName: Testing/MemexPortalShared/ModuleUpdateIdentityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ModuleUpdateIdentityTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("", null, ModuleUpdateAction.SkipUpToDate)]
    [MeshInlineData(null, "", ModuleUpdateAction.SkipUpToDate)]
    [MeshInlineData("   ", "  ", ModuleUpdateAction.SkipUpToDate)]
    [MeshInlineData(OldFramework, "   ", ModuleUpdateAction.SkipUpToDate)]
    [MeshInlineData("", NewFramework, ModuleUpdateAction.Land)]
    [MeshInlineData("  ", NewFramework, ModuleUpdateAction.Land)]
