// <meshweaver>
// Id: Testing/MemexPortalShared/OgCardRendererTest
// DisplayName: Testing/MemexPortalShared/OgCardRendererTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class OgCardRendererTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Claims", null, null)]
    [MeshInlineData("Claims", "", "")]
    [MeshInlineData(
        ...
        "Education")]
    [MeshInlineData("Supercalifragilisticexpialidociousnesslikeaverylongunbrokentoken", "x", "Space")]
