// <meshweaver>
// Id: Testing/MemexPortalShared/PendingModuleActivationsCostTest
// DisplayName: Testing/MemexPortalShared/PendingModuleActivationsCostTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
