// <meshweaver>
// Id: Testing/MemexPortalShared/PlanTierRefusalTest
// DisplayName: Testing/MemexPortalShared/PlanTierRefusalTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PlanTierRefusalTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("enterprise")]
    [MeshInlineData("dedicated")]
