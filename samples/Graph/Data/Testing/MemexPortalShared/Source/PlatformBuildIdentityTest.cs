// <meshweaver>
// Id: Testing/MemexPortalShared/PlatformBuildIdentityTest
// DisplayName: Testing/MemexPortalShared/PlatformBuildIdentityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
