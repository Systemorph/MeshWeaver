// <meshweaver>
// Id: Testing/MemexPortalShared/PlatformUpdateStatusTest
// DisplayName: Testing/MemexPortalShared/PlatformUpdateStatusTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PlatformUpdateStatusTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(ComboVerdictKind.Green)]
    [MeshInlineData(ComboVerdictKind.NotVerifiable)]
