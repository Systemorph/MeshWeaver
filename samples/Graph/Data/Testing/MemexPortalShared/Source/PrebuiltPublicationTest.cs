// <meshweaver>
// Id: Testing/MemexPortalShared/PrebuiltPublicationTest
// DisplayName: Testing/MemexPortalShared/PrebuiltPublicationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </list>
/// </summary>
public class PrebuiltPublicationTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    [MeshTheory]
    [MeshInlineData("/modules", false)]
    [MeshInlineData("/modules/ai.module.nupkg", false)]
    [MeshInlineData("/modules", true)]
    [MeshInlineData("/modules/ai.module.nupkg", true)]
    ...
    [MeshTheory]
    [MeshInlineData("/Store.zip", 3, false)]
    [MeshInlineData("/Store.zip", 3, true)]
    [MeshInlineData("/modules/ai.module.nupkg", 4, false)]
    [MeshInlineData("/modules/ai.module.nupkg", 4, true)]
