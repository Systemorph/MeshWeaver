// <meshweaver>
// Id: Testing/MemexPortalShared/PublicationGenerationTest
// DisplayName: Testing/MemexPortalShared/PublicationGenerationTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class PublicationGenerationTest
{
    ...
    [MeshInlineData("..")]
    [MeshInlineData(".")]
    [MeshInlineData("../secrets")]
    [MeshInlineData("..\\secrets")]
    [MeshInlineData("sub/dir")]
    [MeshInlineData("/etc")]
