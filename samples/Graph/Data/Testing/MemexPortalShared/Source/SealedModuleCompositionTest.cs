// <meshweaver>
// Id: Testing/MemexPortalShared/SealedModuleCompositionTest
// DisplayName: Testing/MemexPortalShared/SealedModuleCompositionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// generation.</para>
/// </summary>
public class SealedModuleCompositionTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    public async Task AResealBetweenTwoModuleFetches_IsRefusedAndReRead_NotSilentlyMixed()
    {
        ...
        try
        {
            ...
            var composed = await new BuildPluginCommand(log, log).ComposeSealedModules(
                Client(app, key), Source, Identity, "AI Essentials", extDir, CancellationToken.None);
