// <meshweaver>
// Id: Testing/MemexPortalShared/SelfUpdateMigratesBeforeItRollsTest
// DisplayName: Testing/MemexPortalShared/SelfUpdateMigratesBeforeItRollsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
