// <meshweaver>
// Id: Testing/MemexPortalShared/SelfUpdateVerdictTest
// DisplayName: Testing/MemexPortalShared/SelfUpdateVerdictTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class SelfUpdateVerdictTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(SelfUpdateOutcome.Applied, true)]
    [MeshInlineData(SelfUpdateOutcome.Held, true)]
    [MeshInlineData(SelfUpdateOutcome.Deferred, true)]
    [MeshInlineData(SelfUpdateOutcome.DetectOnly, true)]
    ...
    [MeshInlineData(SelfUpdateOutcome.ComboBlocked, true)]
    ...
    [MeshInlineData(SelfUpdateOutcome.MigrationFailed, true)]
    [MeshInlineData(SelfUpdateOutcome.NoNewerRelease, false)]
    [MeshInlineData(SelfUpdateOutcome.UpdatesDisabled, false)]
    [MeshInlineData(SelfUpdateOutcome.CheckFailed, false)]
    [MeshInlineData(SelfUpdateOutcome.NoOutcome, false)]
    ...
    [MeshInlineData(SelfUpdateOutcome.Restarted, false)]
    [MeshInlineData(SelfUpdateOutcome.RestartDeferred, false)]
    [MeshInlineData(SelfUpdateOutcome.RestartUnavailable, false)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(SelfUpdateOutcome.NoNewerRelease, true)]
    [MeshInlineData(SelfUpdateOutcome.Held, true)]
    [MeshInlineData(SelfUpdateOutcome.Deferred, true)]
    [MeshInlineData(SelfUpdateOutcome.DetectOnly, true)]
    [MeshInlineData(SelfUpdateOutcome.ComboBlocked, true)]
    [MeshInlineData(SelfUpdateOutcome.InstalledTagWithdrawn, true)]
    [MeshInlineData(SelfUpdateOutcome.Applied, false)]
    [MeshInlineData(SelfUpdateOutcome.MigrationFailed, false)]
    [MeshInlineData(SelfUpdateOutcome.CheckFailed, false)]
    [MeshInlineData(SelfUpdateOutcome.UpdatesDisabled, false)]
    [MeshInlineData(SelfUpdateOutcome.NoOutcome, false)]
