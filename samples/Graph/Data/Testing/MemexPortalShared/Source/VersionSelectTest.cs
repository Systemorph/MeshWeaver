// <meshweaver>
// Id: Testing/MemexPortalShared/VersionSelectTest
// DisplayName: Testing/MemexPortalShared/VersionSelectTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class VersionSelectTest
{
    ...
    [MeshTheory]
    [MeshInlineData("3.0.1-ci*", "3.0.1-ci.12", true)]
    [MeshInlineData("3.0.1-ci*", "3.0.1-CI.12", true)]
    [MeshInlineData("3.0.1-ci*", "3.0.1", false)]
    [MeshInlineData("3.0.1-ci*", "3.0.10-ci.1", false)]
    [MeshInlineData("3.0.?-ci*", "3.0.7-ci.1", true)]
    [MeshInlineData("3.0.?-ci*", "3.0.10-ci.1", false)]
    [MeshInlineData("3.0.*", "3.0.1", true)]
    [MeshInlineData("3.0.*", "3.1.0", false)]
    [MeshInlineData("", "3.0.1", false)]
    [MeshInlineData(null, "3.0.1", false)]
    [MeshInlineData("   ", "3.0.1", false)]
    ...
    [MeshTheory]
    [MeshInlineData("3.1.0-ci.55", "3.0.0-ci.51", true)]  // later run on a higher base wins
    [MeshInlineData("3.0.0-ci.51", "3.0.0-ci.40", true)]  // monotonic ci number
    [MeshInlineData("3.0.0", "3.0.0-ci.51", true)]        // release beats its prerelease
    [MeshInlineData("3.0.0-ci.40", "3.0.0-ci.51", false)] // older ci number
    [MeshInlineData("3.0.0", "3.0.0", false)]             // equal
    [MeshInlineData("3.0.0", "unknown", false)]           // unparseable current → never update
    ...
    [MeshInlineData("3.0.0-ci.52", "3.0.0-ci.51+build.638123456789", true)]
    [MeshInlineData("3.0.0-ci.51", "3.0.0-ci.51+build.638123456789", false)]
    ...
    [MeshTheory]
    [MeshInlineData("3.0.0-ci.7977", 7977L)]
    [MeshInlineData("3.0.0-rc9.ci.7824", 7824L)]
    [MeshInlineData("3.0.0-edge.7977", 7977L)]
    [MeshInlineData("3.0.0-ci.7977+build.638", 7977L)]
    [MeshInlineData("3.0.0", null)]
    [MeshInlineData("3.0.0-rc6", null)]
    [MeshInlineData("main", null)]
