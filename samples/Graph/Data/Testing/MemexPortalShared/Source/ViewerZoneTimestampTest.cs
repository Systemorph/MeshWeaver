// <meshweaver>
// Id: Testing/MemexPortalShared/ViewerZoneTimestampTest
// DisplayName: Testing/MemexPortalShared/ViewerZoneTimestampTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ViewerZoneTimestampTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("ui.updateCheckedAt")]
    [MeshInlineData("ui.updateHeldAt")]
    [MeshInlineData("ui.updateVerifiedAtLine")]
