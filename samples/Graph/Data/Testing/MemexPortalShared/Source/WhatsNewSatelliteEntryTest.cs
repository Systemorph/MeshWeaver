// <meshweaver>
// Id: Testing/MemexPortalShared/WhatsNewSatelliteEntryTest
// DisplayName: Testing/MemexPortalShared/WhatsNewSatelliteEntryTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class WhatsNewSatelliteEntryTest(MeshTestContext context) : InMeshTestBase(output)
{
    [MeshFact]
