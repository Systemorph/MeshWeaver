// <meshweaver>
// Id: Testing/MessagingHub/DeferralTrackerClaimTest
// DisplayName: Testing/MessagingHub/DeferralTrackerClaimTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DeferralTrackerClaimTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    public async Task Two_concurrent_backlog_drains_never_double_dispose_a_deferral_tracker()
    {
        ...
        await client.Observe(new ProbeRequest(), o => o.WithTarget(host.Address))
            .FirstAsync().Timeout(30.Seconds()).Await(CancellationToken.None);
