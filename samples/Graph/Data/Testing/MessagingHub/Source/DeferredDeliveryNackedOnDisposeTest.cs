// <meshweaver>
// Id: Testing/MessagingHub/DeferredDeliveryNackedOnDisposeTest
// DisplayName: Testing/MessagingHub/DeferredDeliveryNackedOnDisposeTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DeferredDeliveryNackedOnDisposeTest : InMeshTestBase
{
    private readonly DeferredLog log = new();

    public DeferredDeliveryNackedOnDisposeTest(MeshTestContext context) : base(context)
    {
    ...
    public async Task DeferredRequest_IsNacked_WhenHubIsDisposedBeforeItsGateOpens()
    {
        ...
        // WITHOUT the fix this task never completes and the [MeshFact] timeout fires with no
