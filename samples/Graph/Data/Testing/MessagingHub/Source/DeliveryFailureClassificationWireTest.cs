// <meshweaver>
// Id: Testing/MessagingHub/DeliveryFailureClassificationWireTest
// DisplayName: Testing/MessagingHub/DeliveryFailureClassificationWireTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class DeliveryFailureClassificationWireTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(ErrorType.Exception)]
    [MeshInlineData(ErrorType.NotFound)]
    [MeshInlineData(ErrorType.CompilationFailed)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(ErrorType.ShuttingDown)]
    [MeshInlineData(ErrorType.Unavailable)]
    [MeshInlineData(ErrorType.NotFound)]
    [MeshInlineData(ErrorType.CompilationFailed)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(long.MaxValue)]      // out of int range — Convert.ToInt32 would throw here
    [MeshInlineData(long.MinValue)]
    [MeshInlineData(9999)]               // in range, but no such member
