// <meshweaver>
// Id: Testing/MessagingHub/DisposalDeadlockDiagnosticsTest
// DisplayName: Testing/MessagingHub/DisposalDeadlockDiagnosticsTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DisposalDeadlockDiagnosticsTest : InMeshTestBase
{
    private readonly DeadlockLogCapture _capture = new();

    public DisposalDeadlockDiagnosticsTest(MeshTestContext context) : base(context)
    {
