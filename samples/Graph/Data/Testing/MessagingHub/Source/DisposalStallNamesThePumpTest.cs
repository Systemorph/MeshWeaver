// <meshweaver>
// Id: Testing/MessagingHub/DisposalStallNamesThePumpTest
// DisplayName: Testing/MessagingHub/DisposalStallNamesThePumpTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DisposalStallNamesThePumpTest : InMeshTestBase
{
    private readonly VerdictCapture capture = new();

    public DisposalStallNamesThePumpTest(MeshTestContext context) : base(context)
    {
