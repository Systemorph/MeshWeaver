// <meshweaver>
// Id: Testing/MessagingHub/DisposalStallWatchdogTest
// DisplayName: Testing/MessagingHub/DisposalStallWatchdogTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class DisposalStallWatchdogTest : InMeshTestBase
{
    private readonly DeadlockLogCapture capture = new();

    public DisposalStallWatchdogTest(MeshTestContext context) : base(context)
    {
