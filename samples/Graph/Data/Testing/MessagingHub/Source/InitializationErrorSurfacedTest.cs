// <meshweaver>
// Id: Testing/MessagingHub/InitializationErrorSurfacedTest
// DisplayName: Testing/MessagingHub/InitializationErrorSurfacedTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class InitializationErrorSurfacedTest(MeshTestContext context) : InMeshTestBase(output)
{
...
/// </summary>
public class InitializationHangSurfacedTest(MeshTestContext context) : InMeshTestBase(output)
{
    protected override MessageHubConfiguration ConfigureHost(MessageHubConfiguration configuration)
        => configuration
