// <meshweaver>
// Id: Testing/MessagingHub/ObjectAsPrivatePayloadTest
// DisplayName: Testing/MessagingHub/ObjectAsPrivatePayloadTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
{
    [MeshTheory]
    [MeshInlineData(false, false, 0)]
    [MeshInlineData(false, true, 0)]
    [MeshInlineData(true, false, 0)]
    [MeshInlineData(true, true, 0)]
    [MeshInlineData(false, false, 1)]
    [MeshInlineData(false, true, 1)]
    [MeshInlineData(true, false, 1)]
    [MeshInlineData(true, true, 1)]
    [MeshInlineData(false, false, 2)]
    [MeshInlineData(false, true, 2)]
    [MeshInlineData(true, false, 2)]
    [MeshInlineData(true, true, 2)]
