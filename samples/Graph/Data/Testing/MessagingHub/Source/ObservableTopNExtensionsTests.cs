// <meshweaver>
// Id: Testing/MessagingHub/ObservableTopNExtensionsTests
// DisplayName: Testing/MessagingHub/ObservableTopNExtensionsTests — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ObservableTopNExtensionsTests
{
    ...
    public async Task IAsyncEnumerableOverload_DisposalCancelsIterator()
    {
        ...
        var sub = StallingSource(started, () => cancelled = true, CancellationToken.None)
            .ScanTopN(3, AscInt)
            .Subscribe(_ => { });
