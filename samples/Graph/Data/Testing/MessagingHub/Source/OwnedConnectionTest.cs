// <meshweaver>
// Id: Testing/MessagingHub/OwnedConnectionTest
// DisplayName: Testing/MessagingHub/OwnedConnectionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class OwnedConnectionTest(MeshTestContext context) : InMeshTestBase(output)
{
    [MeshFact]
