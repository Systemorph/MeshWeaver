// <meshweaver>
// Id: Testing/MessagingHub/QuiesceStartNamesTheAskerTest
// DisplayName: Testing/MessagingHub/QuiesceStartNamesTheAskerTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class QuiesceStartNamesTheAskerTest : InMeshTestBase
{
    private readonly QuiesceLogCapture _capture = new();

    public QuiesceStartNamesTheAskerTest(MeshTestContext context) : base(context)
    {
    ...
    private async Task<string> QuiesceLineFor(MessageHub hub)
    {
        ...
        // stays strictly below the [MeshFact(Timeout)] outer bound, so a wait that loses says WHAT did
