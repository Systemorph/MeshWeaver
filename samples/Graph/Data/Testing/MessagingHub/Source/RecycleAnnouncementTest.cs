// <meshweaver>
// Id: Testing/MessagingHub/RecycleAnnouncementTest
// DisplayName: Testing/MessagingHub/RecycleAnnouncementTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class RecycleAnnouncementTest(MeshTestContext context) : InMeshTestBase(context)
{
    ...
    public async Task RoutedDisposeRequest_Announces_Once_AndBeforeTheTeardownStarts()
    {
        ...
        await recycled!.Started.WaitAsync(TimeSpan.FromSeconds(30), CancellationToken.None);
    ...
    public async Task DirectDispose_DoesNotAnnounce()
    {
        ...
        await direct!.Started.WaitAsync(TimeSpan.FromSeconds(30), CancellationToken.None);
