// <meshweaver>
// Id: Testing/MessagingHub/ReleaseFactTest
// DisplayName: Testing/MessagingHub/ReleaseFactTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ReleaseFactTest
{
    ...
    [MeshInlineData("systemorph/meshweaver.plugins", "MeshWeaver.Blazor.EntityViews")]
    [MeshInlineData("Systemorph/MeshWeaver.Plugins", "meshweaver.blazor.entityviews")]
    [MeshInlineData("SYSTEMORPH/MESHWEAVER.PLUGINS", "MESHWEAVER.BLAZOR.ENTITYVIEWS")]
    ...
    [MeshInlineData("Systemorph/MeshWeaver.Plugins", "MeshWeaver.Blazor.EntityViews", "3.0.0-rc8.ci.5433")]
    // same package NAME from a different repo — a distinct artefact that must not collide
    [MeshInlineData("Systemorph/MeshWeaver", "MeshWeaver.Blazor.EntityViews", "3.0.0-rc8.ci.5432")]
    // same repo and version, different package — a repo publishes SEVERAL facts per release
    [MeshInlineData("Systemorph/MeshWeaver.Plugins", "MeshWeaver.Blazor.Radzen", "3.0.0-rc8.ci.5432")]
