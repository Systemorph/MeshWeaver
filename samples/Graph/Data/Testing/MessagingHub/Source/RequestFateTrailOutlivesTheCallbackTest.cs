// <meshweaver>
// Id: Testing/MessagingHub/RequestFateTrailOutlivesTheCallbackTest
// DisplayName: Testing/MessagingHub/RequestFateTrailOutlivesTheCallbackTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class RequestFateTrailOutlivesTheCallbackTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    public async Task AfterTheRequestersObserveTimedOut_TheTrailStillRendersTheReceivingSide()
    {
        ...
        var handled = await handlerRan.Task.WaitAsync(TimeSpan.FromSeconds(10), CancellationToken.None);
