// <meshweaver>
// Id: Testing/MessagingHub/RouterTrafficDetectorTest
// DisplayName: Testing/MessagingHub/RouterTrafficDetectorTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class RouterTrafficDetectorTest : InMeshTestBase
{
    ...
    public RouterTrafficDetectorTest(MeshTestContext context) : base(context)
    {
