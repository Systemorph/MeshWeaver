// <meshweaver>
// Id: Testing/MessagingHub/RouterTrafficRuleTest
// DisplayName: Testing/MessagingHub/RouterTrafficRuleTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class RouterTrafficRuleTest
{
    ...
    [MeshTheory]
    [MeshInlineData(Mesh, "portal", "target")]
    [MeshInlineData("portal", Mesh, "sender")]
    [MeshInlineData(Mesh, Mesh, "sender AND target")]
    ...
    [MeshTheory]
    [MeshInlineData("portal", "client")]
    [MeshInlineData("import", "mesh-ish")]   // near-miss must NOT match
    [MeshInlineData("client", null)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(Mesh, "ApiToken", true, "target")]   // response back to a router-issued request
    [MeshInlineData("portal", Mesh, false, "sender")]    // router originating work (no correlation)
    [MeshInlineData(Mesh, Mesh, true, "sender AND target")]
