// <meshweaver>
// Id: Testing/MessagingHub/ShutdownWindowAdmissionTest
// DisplayName: Testing/MessagingHub/ShutdownWindowAdmissionTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class ShutdownWindowAdmissionTest : InMeshTestBase
{
    private readonly TeardownLog teardown = new();

    public ShutdownWindowAdmissionTest(MeshTestContext context) : base(context)
    {
