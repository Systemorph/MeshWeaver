// <meshweaver>
// Id: Testing/MessagingHub/TimeoutMessageNamesTheCallersOwnStateTest
// DisplayName: Testing/MessagingHub/TimeoutMessageNamesTheCallersOwnStateTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class TimeoutMessageNamesTheCallersOwnStateTest(MeshTestContext context) : InMeshTestBase(output)
{
    ...
    /// carry no <c>[MeshFact(Timeout = …)]</c> — the hub's own <c>RequestTimeout</c> IS the thing under
