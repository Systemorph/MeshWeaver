// <meshweaver>
// Id: Testing/PluginTester/BakeOutputTest
// DisplayName: Testing/PluginTester/BakeOutputTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class BakeOutputTest(MeshTestContext context)
{
    ...
    public async Task GateRunWithBakeOutput_WritesABundleTheConsumersGateAccepts()
    {
        ...
        try
        {
            ...
            var surface = MeshWeaver.Mesh.ModulePlatformSurface.FromJson(
                await File.ReadAllTextAsync(surfaceFile, CancellationToken.None));
            ...
            var (manifest, assemblies) = BundleReader.Read(
                await File.ReadAllBytesAsync(bundlePath, CancellationToken.None));
