// <meshweaver>
// Id: Testing/PluginTester/GateAllowlistTest
// DisplayName: Testing/PluginTester/GateAllowlistTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class GateAllowlistTest
{
    ...
    [MeshTheory]
    [MeshInlineData("Claims")]                      // missing check
    [MeshInlineData("Claims idempotence extra")]    // too many tokens
    [MeshInlineData("Claims flakiness")]            // unknown check name
