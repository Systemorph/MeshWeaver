// <meshweaver>
// Id: Testing/PluginTester/GateInstallsUpstreamPackagesTest
// DisplayName: Testing/PluginTester/GateInstallsUpstreamPackagesTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
/// </summary>
public class GateInstallsUpstreamPackagesTest(MeshTestContext context)
{
    ...
    private sealed class StringWriterAdapter(MeshTestContext context) : StringWriter
    {
