// <meshweaver>
// Id: Testing/PluginTester/GateNamesTheRealCauseTest
// DisplayName: Testing/PluginTester/GateNamesTheRealCauseTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class GateNamesTheRealCauseTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(CheckOutcome.Inconclusive)]
    [MeshInlineData(CheckOutcome.Unrecorded)]
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData(CheckOutcome.Inconclusive, GateRunOutcome.Inconclusive)]
    [MeshInlineData(CheckOutcome.Unrecorded, GateRunOutcome.Unrecorded)]
