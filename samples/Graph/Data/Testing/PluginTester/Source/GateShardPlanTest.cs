// <meshweaver>
// Id: Testing/PluginTester/GateShardPlanTest
// DisplayName: Testing/PluginTester/GateShardPlanTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class GateShardPlanTest
{
    ...
    [MeshTheory]
    [MeshInlineData("2/4", 2, 4)]
    [MeshInlineData("1/1", 1, 1)]
    ...
    [MeshTheory]
    [MeshInlineData("4")]        // no total — would otherwise read as shard 4 of everything
    [MeshInlineData("0/4")]      // 0-based off-by-one: the whole first slice would go ungated
    [MeshInlineData("5/4")]      // past the end: an empty slice that looks like a shard doing its share
    [MeshInlineData("2/0")]      // no shards at all
    [MeshInlineData("a/b")]
