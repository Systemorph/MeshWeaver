// <meshweaver>
// Id: Testing/PluginTester/ManifestResourceNamesTest
// DisplayName: Testing/PluginTester/ManifestResourceNamesTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ManifestResourceNamesTest
{
    ...
    [MeshTheory]
    [MeshInlineData("Data", "Data")]
    [MeshInlineData("Data/Nested", "Data.Nested")]
    [MeshInlineData("with-dash", "with_dash")]                  // an invalid character becomes '_'
    [MeshInlineData("9digits", "_9digits")]                     // a leading digit is PREFIXED
    [MeshInlineData("space dir", "space_dir")]
    [MeshInlineData("Dot.Dir", "Dot.Dir")]                      // a dot is a SEPARATOR, not a character
    [MeshInlineData("Dot.9Dir", "Dot._9Dir")]                   // …so each half is mangled on its own
    [MeshInlineData("--", "__")]
    [MeshInlineData("_", "__")]                                 // a lone underscore is DOUBLED
    [MeshInlineData("ü-dir", "ü_dir")]                          // a letter is a letter, ASCII or not
    [MeshInlineData("x y.z-w", "x_y.z_w")]
    [MeshInlineData("deep/a-b/9c", "deep.a_b._9c")]
    [MeshInlineData("", "")]
    ...
    [MeshTheory]
    [MeshInlineData("Foo.de.md", "de")]
    [MeshInlineData("Foo.de-DE.md", "de-DE")]
    [MeshInlineData("strings.en.json", "en")]
    [MeshInlineData("Foo.zz.md", null)]
    [MeshInlineData("Foo.notaculture.md", null)]
    [MeshInlineData("Plain.md", null)]
    [MeshInlineData("Weird-File.Name.md", null)]
    ...
    [MeshTheory]
    [MeshInlineData("Foo.de.md", true)]
    [MeshInlineData("Foo.md", false)]
    [MeshInlineData("Foo", false)]
