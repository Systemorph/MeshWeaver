// <meshweaver>
// Id: Testing/PluginTester/NodeSetQueryTest
// DisplayName: Testing/PluginTester/NodeSetQueryTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class NodeSetQueryTest
{
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("laptop nodeType:Code")]              // free text → vector search on a real mesh
    [MeshInlineData("namespace:*/Source nodeType:Code")]  // wildcard
    [MeshInlineData("path:A|B nodeType:Code")]            // alternation
    [MeshInlineData("state:Active nodeType:Code")]        // a selector outside the grammar
    [MeshInlineData("namespace:Source scope:ancestors")]  // a scope walk with no source meaning
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("Widget/Thing", "Widget_Thing")]
    [MeshInlineData("A//B", "A_B")]
    [MeshInlineData("1Thing", "Node_1Thing")]
    [MeshInlineData("/Leading", "Leading")]
