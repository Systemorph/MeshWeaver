// <meshweaver>
// Id: Testing/PluginTester/ProjectAssemblyIdentityTest
// DisplayName: Testing/PluginTester/ProjectAssemblyIdentityTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ProjectAssemblyIdentityTest : IDisposable
{
    ...
    private static Task<ProjectBuild.Report> Build(ProjectBuild.Options options) =>
        ProjectBuild.Run(options).Await(CancellationToken.None);
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("1.2.3-beta.4", "1.2.3.0")]   // the pre-release label is dropped
    [MeshInlineData("1.2.3+meta", "1.2.3.0")]     // …so is build metadata
    [MeshInlineData("1.2.3.4", "1.2.3.4")]        // four fields survive intact
    [MeshInlineData("1.2.3", "1.2.3.0")]          // three are padded
    [MeshInlineData("4.5", "4.5.0.0")]            // two are padded
    [MeshInlineData("1", "1.0.0.0")]              // one is padded
    [MeshInlineData("01.2.3", "1.2.3.0")]         // leading zeros normalise
    ...
    /// </summary>
    [MeshTheory]
    [MeshInlineData("1.2.3", "1.2.3+abc123")]
    [MeshInlineData("1.2.3+meta", "1.2.3+meta.abc123")]
