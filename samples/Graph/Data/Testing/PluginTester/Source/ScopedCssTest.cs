// <meshweaver>
// Id: Testing/PluginTester/ScopedCssTest
// DisplayName: Testing/PluginTester/ScopedCssTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class ScopedCssTest : IDisposable
{
    ...
    [MeshTheory]
    [MeshInlineData("Components/CodeBlock.razor.css", "MeshWeaver.Blazor", "b-h3pg7owarf")]
    [MeshInlineData("Components/DialogView.razor.css", "MeshWeaver.Blazor", "b-qf8u66cq1w")]
    [MeshInlineData("FileExplorer/FileBrowser.razor.css", "MeshWeaver.Blazor", "b-1v0kb17jfa")]
