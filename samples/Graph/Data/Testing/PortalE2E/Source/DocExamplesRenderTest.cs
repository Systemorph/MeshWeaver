// <meshweaver>
// Id: Testing/PortalE2E/DocExamplesRenderTest
// DisplayName: Testing/PortalE2E/DocExamplesRenderTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class DocExamplesRenderTest(PortalFixture fixture)
{
    ...
    /// <summary>The <c>Edit</c> macro renders a generated form (<c>&lt;dl class="form-group"&gt;</c>),
    /// NOT a Stack — asserting Stack here only ever passed by accident of an older example.</summary>
    private const string EditorForm = ".layout-area .form-group";
