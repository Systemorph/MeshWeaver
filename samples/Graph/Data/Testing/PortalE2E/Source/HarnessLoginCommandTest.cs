// <meshweaver>
// Id: Testing/PortalE2E/HarnessLoginCommandTest
// DisplayName: Testing/PortalE2E/HarnessLoginCommandTest — migrated from xunit (convert-xunit-to-inmesh.py)
// </meshweaver>
#nullable enable
...
public class HarnessLoginCommandTest(PortalFixture fixture)
{
    ...
    [MeshInlineData("ClaudeCode", "Claude Code")]
    [MeshInlineData("Copilot", "GitHub Copilot")]
