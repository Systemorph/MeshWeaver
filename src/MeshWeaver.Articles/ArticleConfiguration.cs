...
public record ArticleConfiguration
{
    ...
    internal ImmutableList<Func<ArticleOptions, Task<Article>>> ArticleStreamFactories { get; init; } = [];

    public ArticleConfiguration WithArticleStreamFactory(Func<ArticleOptions, Task<Article>> factory)
