...
/// <summary>
/// Custom brand and feature SVG icons used across the portal, grouped by render size.
/// </summary>
public static class PortalIcons
{
    /// <summary>
    /// Custom SVG icons rendered at 20px.
    /// </summary>
    public static class Size20
    {
        /// <summary>
        /// Custom GitHub SVG icon at 20px. Initializes the icon.
        /// </summary>
        public sealed class GitHub() : Icon("GitHub", IconVariant.Filled, IconSize.Size20,
        ...
        /// <summary>
        /// Custom Discord SVG icon at 20px. Initializes the icon.
        /// </summary>
        public sealed class Discord() : Icon("Discord", IconVariant.Filled, IconSize.Size20,
    ...
    /// <summary>
    /// Custom SVG icons rendered at 24px.
    /// </summary>
    public static class Size24
    {
        /// <summary>
        /// Custom GitHub SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class GitHub() : Icon("GitHub", IconVariant.Filled, IconSize.Size24,
        ...
        /// <summary>
        /// Custom Discord SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class Discord() : Icon("Discord", IconVariant.Filled, IconSize.Size24,
            @"<path transform='translate(0,3) scale(0.09375) translate(0,28.5)' fill-rule='evenodd' clip-rule='evenodd' fill='#5865F2' d='M216.856339,16.5966031 C200.285002,8.84328665 182.566144,3.2084988 164.041564,0 C161.766523,4.11318106 159.108624,9.64549908 157.276099,14.0464379 C137.583995,11.0849896 118.072967,11.0849896 98.7430163,14.0464379 C96.9108417,9.64549908 94.1925838,4.11318106 91.8971895,0 C73.3526068,3.2084988 55.6133949,8.86399117 39.0420583,16.6376612 C5.61752293,67.146514 -3.4433191,116.400813 1.08711069,164.955721 C23.2560196,181.510915 44.7403634,191.567697 65.8621325,198.148576 C71.0772151,190.971126 75.7283628,183.341335 79.7352139,175.300261 C72.104019,172.400575 64.7949724,168.822202 57.8887866,164.667963 C59.7209612,163.310589 61.5131304,161.891452 63.2445898,160.431257 C105.36741,180.133187 151.134928,180.133187 192.754523,160.431257 C194.506336,161.891452 196.298154,163.310589 198.110326,164.667963 C191.183787,168.842556 183.854737,172.420929 176.223542,175.320965 C180.230393,183.341335 184.861538,190.991831 190.096624,198.16893 C211.238746,191.588051 232.743023,181.531619 254.911949,164.955721 C260.227747,108.668201 245.831087,59.8662432 216.856339,16.5966031 Z M85.4738752,135.09489 C72.8290281,135.09489 62.4592217,123.290155 62.4592217,108.914901 C62.4592217,94.5396472 72.607595,82.7145587 85.4738752,82.7145587 C98.3405064,82.7145587 108.709962,94.5189427 108.488529,108.914901 C108.508531,123.290155 98.3405064,135.09489 85.4738752,135.09489 Z M170.525237,135.09489 C157.88039,135.09489 147.510584,123.290155 147.510584,108.914901 C147.510584,94.5396472 157.658606,82.7145587 170.525237,82.7145587 C183.391518,82.7145587 193.761324,94.5189427 193.539891,108.914901 C193.539891,123.290155 183.391518,135.09489 170.525237,135.09489 Z'/>");

        /// <summary>
        /// Custom YouTube SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class YouTube() : Icon("YouTube", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.05205)'>
        <path fill-rule='evenodd' clip-rule='evenodd' fill='#F61C0D' d='M365.257,67.393H95.744C42.866,67.393,0,110.259,0,163.137v134.728 c0,52.878,42.866,95.744,95.744,95.744h269.513c52.878,0,95.744-42.866,95.744-95.744V163.137 C461.001,110.259,418.135,67.393,365.257,67.393z'/>
        ...
        /// <summary>
        /// Custom LinkedIn SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class LinkedIn() : Icon("LinkedIn", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.07742)'>
        <path fill-rule='evenodd' clip-rule='evenodd' fill='#0077B5' d='M72.16,99.73H9.927c-2.762,0-5,2.239-5,5v199.928c0,2.762,2.238,5,5,5H72.16 c2.762,0,5-2.238,5-5V104.73 C77.16,101.969,74.922,99.73,72.16,99.73z'/>
        <path fill-rule='evenodd' clip-rule='evenodd' fill='#0077B5' d='M41.066,0.341C18.422,0.341,0,18.743,0,41.362 C0,63.991,18.422,82.4,41.066,82.4c22.626,0,41.033-18.41,41.033-41.038 C82.1,18.743,63.692,0.341,41.066,0.341z'/>
        <path fill-rule='evenodd' clip-rule='evenodd' fill='#0077B5' d='M230.454,94.761c-24.995,0-43.472,10.745-54.679,22.954V104.73 c0-2.761-2.238-5-5-5h-59.599 c-2.762,0-5,2.239-5,5v199.928c0,2.762,2.238,5,5,5h62.097c2.762,0,5-2.238,5-5v-98.918c0-33.333,9.054-46.319,32.29-46.319 c25.306,0,27.317,20.818,27.317,48.034v97.204c0,2.762,2.238,5,5,5H305c2.762,0,5-2.238,5-5V194.995 C310,145.43,300.549,94.761,230.454,94.761z'/>
    </g>"
        );

        /// <summary>
        /// Custom Bluesky SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class Bluesky() : Icon("Bluesky", IconVariant.Filled, IconSize.Size24,
            @"<path transform='scale(0.04)' class='bluesky-icon' fill='#0084FF' d='M299.75 238.48c-26.326-51.01-97.736-146.28-164.21-193.17-63.677-44.92-88.028-37.19-103.82-29.95-18.428 8.39-21.719 36.69-21.719 53.31s9.05 136.57 15.138 156.48c19.745 66.15 89.674 88.52 154.17 81.28 3.29-0.49 6.58-0.99 10.04-1.32-3.29 0.49-6.75 0.99-10.04 1.32-94.445 13.99-178.52 48.37-68.284 170.96 121.1 125.38 166.02-26.82 189.06-104.15 23.035 77.17 49.526 223.94 186.75 104.15 103.17-104.15 28.301-156.97-66.145-170.96-3.29-0.33-6.75-0.82-10.04-1.32 3.46 0.49 6.75 0.82 10.04 1.32 64.499 7.24 134.59-15.14 154.17-81.28 5.92-20.07 15.14-139.86 15.14-156.48s-3.29-44.92-21.72-53.31c-15.96-7.24-40.15-14.97-103.82 29.95-66.97 47.06-138.38 142.16-164.7 193.17z'/>");

        /// <summary>
        /// Custom X (Twitter) SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class X() : Icon("X", IconVariant.Filled, IconSize.Size24,
        ...
        /// <summary>
        /// Custom Threads SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class Threads() : Icon("Threads", IconVariant.Filled, IconSize.Size24,
        ...
        /// <summary>
        /// Custom Northwind sample SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class Northwind() : Icon("Northwind", IconVariant.Filled, IconSize.Size24,
        ...
        /// <summary>
        /// Custom Northwind sample SVG icon (active state) at 24px. Initializes the icon.
        /// </summary>
        public sealed class NorthwindActive() : Icon("NorthwindActive", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
                <g stroke='currentColor' stroke-width='6' stroke-linejoin='round' stroke-linecap='round' fill='none'>
                    <rect x='54' y='32' width='12' height='20' fill='currentColor'/>
                    <path d='M60 52 L48 108 L72 108 Z' fill='currentColor'/>
        ...
        /// <summary>
        /// Custom Northwind article SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class NorthwindArticle() : Icon("NorthwindArticle", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
                <g stroke='currentColor' stroke-width='6' stroke-linejoin='round' stroke-linecap='round' fill='none'>
                    <rect x='54' y='32' width='12' height='20' fill='currentColor'/>
                    <path d='M60 52 L48 108 L72 108 Z' fill='currentColor'/>
        ...
        /// <summary>
        /// Custom Northwind article SVG icon (active state) at 24px. Initializes the icon.
        /// </summary>
        public sealed class NorthwindArticleActive() : Icon("NorthwindArticleActive", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
                <g stroke='currentColor' stroke-width='6' stroke-linejoin='round' stroke-linecap='round' fill='none'>
        ...
        /// <summary>
        /// Custom Todo article SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class TodoArticle() : Icon("TodoArticle", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
        ...
        /// <summary>
        /// Custom Todo article SVG icon (active state) at 24px. Initializes the icon.
        /// </summary>
        public sealed class TodoArticleActive() : Icon("TodoArticleActive", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
        ...
        /// <summary>
        /// Custom Documentation article SVG icon at 24px. Initializes the icon.
        /// </summary>
        public sealed class DocumentationArticle() : Icon("DocumentationArticle", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
        ...
        /// <summary>
        /// Custom Documentation article SVG icon (active state) at 24px. Initializes the icon.
        /// </summary>
        public sealed class DocumentationArticleActive() : Icon("DocumentationArticleActive", IconVariant.Filled, IconSize.Size24,
            @"<g transform='scale(0.2)'>
