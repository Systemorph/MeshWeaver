...
public static class BlazorClientRegistry
{
    ...
    )
    {
        ...
        return control switch
        {
            ...
            TextBoxControl textbox => StandardView<TextBoxControl, TextboxView>(textbox, stream, area),
            SearchControl search => StandardView<SearchControl, SearchView>(search, stream, area),
