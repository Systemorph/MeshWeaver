...
namespace MeshWeaver.Charting.Models.Options.Scales.Ticks
{
    public record Time
    {
        ...
        /// </summary>
        public TimeDisplayFormat DisplayFormats { get; init; } = null!;
        ...
        /// </summary>
        public object Parser { get; init; } = null!;
        ...
        /// </summary>
        public string TooltipFormat { get; init; } = null!;
        ...
        /// </summary>
        public string MinUnit { get; init; } = null!;
    }
}
