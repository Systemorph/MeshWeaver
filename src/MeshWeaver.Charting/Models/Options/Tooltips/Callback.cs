namespace MeshWeaver.Charting.Models.Options.Tooltips
{
    public record Callback
    {
        ...
        /// </summary>
        public object BeforeTitle { get; init; } = null!;

        /// <summary>
        /// Text to render as the title.
        /// </summary>
        public object Title { get; init; } = null!;

        /// <summary>
        /// Text to render after the title.
        /// </summary>
        public object AfterTitle { get; init; } = null!;

        /// <summary>
        /// Text to render before the body section.
        /// </summary>
        public object BeforeBody { get; init; } = null!;

        /// <summary>
        /// Text to render before an individual label.
        /// </summary>
        public object BeforeLabel { get; init; } = null!;
        ...
        /// </summary>
        public object LabelColor { get; init; } = null!;

        /// <summary>
        /// Returns the colors for the text of the label for the tooltip item.
        /// </summary>
        public object LabelTextColor { get; init; } = null!;
        ...
        /// </summary>
        public object LabelPointStyle { get; init; } = null!;

        /// <summary>
        /// Text to render after an individual label.
        /// </summary>
        public object AfterLabel { get; init; } = null!;

        /// <summary>
        /// Text to render after the body section.
        /// </summary>
        public object AfterBody { get; init; } = null!;

        /// <summary>
        /// Text to render before the footer section.
        /// </summary>
        public object BeforeFooter { get; init; } = null!;

        /// <summary>
        /// Text to render as the footer.
        /// </summary>
        public object Footer { get; init; } = null!;

        /// <summary>
        /// Text to render after the footer section.
        /// </summary>
        public object AfterFooter { get; init; } = null!;
    }
}
