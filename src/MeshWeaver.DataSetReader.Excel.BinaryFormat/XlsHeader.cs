...
namespace MeshWeaver.DataSetReader.Excel.BinaryFormat
{
	...
	internal class XlsHeader
	{
		...
		{
			get { return BitConverter.ToUInt64(_bytes, 0x0); }
		}
		...
		{
			get { return BitConverter.ToUInt16(_bytes, 0x18); }
		}
		...
		{
			get { return BitConverter.ToUInt16(_bytes, 0x1A); }
		}
		...
		{
			get { return BitConverter.ToUInt16(_bytes, 0x1C); }
		}
		...
		{
			get { return (1 << BitConverter.ToUInt16(_bytes, 0x1E)); }
		}
		...
		{
			get { return (1 << BitConverter.ToUInt16(_bytes, 0x20)); }
		}
		...
		{
			get { return BitConverter.ToInt32(_bytes, 0x2C); }
		}
		...
		{
			get { return BitConverter.ToUInt32(_bytes, 0x30); }
		}
		...
		{
			get { return BitConverter.ToUInt32(_bytes, 0x34); }
		}
		...
		{
			get { return BitConverter.ToUInt32(_bytes, 0x38); }
		}
		...
		{
			get { return BitConverter.ToUInt32(_bytes, 0x3C); }
		}
		...
		{
			get { return BitConverter.ToInt32(_bytes, 0x40); }
		}
		...
		{
			get { return BitConverter.ToInt32(_bytes, 0x48); }
		}
		...
		{
            // TODO V10: This entire file must be killed #18359 (24.12.2020, Andrei Sirotenko)
...
#pragma warning restore 0652
			...
			uint miniFatStartSector = BitConverter.ToUInt32(_bytes, 0x3c);
