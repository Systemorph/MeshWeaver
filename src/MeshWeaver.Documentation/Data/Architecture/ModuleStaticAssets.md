...
| 1 — the BUNDLE declares what the tree implies | `.github/scripts/check-bundle-static-assets.py`, in every satellite's pack lane, per file, both compilers, no precondition | its `--self-test`: 12 cases, 5 of which MUST fail the gate |
