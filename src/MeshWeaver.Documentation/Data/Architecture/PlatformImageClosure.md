...
|---|---|---|---|
| `ci.7755` `/app` | **RED** — `MeshWeaver.Markdown.Collaboration` in the closure *and* the manifest | OK (377 refs) | `1` |
| `ci.7794` `/app` | OK | **RED** — `MSB3277`, `SQLitePCLRaw.core` 2.1.11.2622 ↔ 3.0.2.2801 | `1` |
