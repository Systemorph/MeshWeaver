...
Description: >-
  Why the permission fold's mesh-wide reads cannot be anchored to the viewer's partition — anchoring
  them is a silent security regression, not an optimisation — plus the measured core census of
  unanchored render-path queries and the per-caller verdicts for #2640.
