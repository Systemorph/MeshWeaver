...
The four labels are now localized (`node.meta.*`). They had been hard-coded English since the line
was written, which meant a German viewer read `Type:` / `Created:` / `Updated:` regardless of
profile — invisible for as long as nobody added a fifth.
