...
public static class DocumentationExtensions
{
        ...
        IReadOnlySet<string>? serveFromPartition = null) where TBuilder : MeshBuilder
    {
        ...
        // (e.g. the Unified Path page's @@content/logo.svg) into the node's runtime content
        // collection. Without this the node hub can't resolve DocContent. See StaticRepoImport.md.
