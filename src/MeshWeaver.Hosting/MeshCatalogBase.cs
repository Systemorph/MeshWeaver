...
public abstract class MeshCatalogBase : IMeshCatalog
{
    ...
    private readonly Dictionary<string, StreamInfo> channelTypes = new() { { ApplicationAddress.TypeName, new(StreamType.Channel, StreamProviders.Hub, ChannelNames.Hub) } };
