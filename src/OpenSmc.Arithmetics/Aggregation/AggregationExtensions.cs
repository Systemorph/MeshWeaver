...
{
    /// <summary>
    /// The <see cref="AggregationExtensions"/> class contains extension methods to Aggregate data grouped by or over a subset of <see cref="IdentityPropertiesAttribute">Identity Properties</see>
    /// </summary>
