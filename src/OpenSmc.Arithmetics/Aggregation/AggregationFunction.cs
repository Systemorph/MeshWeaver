...
namespace OpenSmc.Arithmetics.Aggregation
{
    ...
    public static class AggregationFunction
    {
        ...
        private static readonly ConcurrentDictionary<Type, IAggregationFunctionProvider> AggregationFunctionProviders = new();
        ...
        public static void RegisterAggregationProvider(IAggregationFunctionProvider provider, Action<AggregationFunctionConventionService, Type> conventionAction)
        {
            var type = provider.GetType();
            conventionAction(AggregationFunctionConventionService.Instance, type);
            AggregationFunctionProviders[provider.GetType()] = provider;
        }
        ...
        {
            var aggregationFunctionProvider = AggregationFunctionConventionService.Instance.Reorder(AggregationFunctionProviders.Values, elementType).FirstOrDefault();
