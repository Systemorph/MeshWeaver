...
function clone$1$1(source) {
  ...
  if (isObject$2(source)) {
    ...
    let k = 0;
    for (; k < klen; ++k) {
      target[keys2[k]] = clone$1$1(source[keys2[k]]);
    }
    return target;
  }
  return source;
...
function _merger(key, target, source, options) {
  ...
  if (isObject$2(tval) && isObject$2(sval)) {
...
function _alignPixel(chart2, pixel, width) {
  const devicePixelRatio2 = chart2.currentDevicePixelRatio;
...
function _readValueToProps(value, props) {
  const ret = {};
  const objProps = isObject$2(props);
  const keys2 = objProps ? Object.keys(props) : props;
  const read = isObject$2(value) ? objProps ? (prop) => valueOrDefault(value[prop], value[props[prop]]) : (prop) => value[prop] : () => value;
...
function _descriptors(proxy, defaults2 = { scriptable: true, indexable: true }) {
  ...
  return {
    ...
    isScriptable: isFunction$2(_scriptable) ? _scriptable : () => _scriptable,
    isIndexable: isFunction$2(_indexable) ? _indexable : () => _indexable
  };
}
const readKey = (prefix, name) => prefix ? prefix + _capitalize(name) : name;
const needsSubResolver = (prop, value) => isObject$2(value) && prop !== "adapters" && (Object.getPrototypeOf(value) === null || value.constructor === Object);
...
function _resolveWithContext(target, prop, receiver) {
  ...
  if (isFunction$2(value) && descriptors2.isScriptable(prop)) {
...
function resolveFallback(fallback, prop, value) {
  return isFunction$2(fallback) ? fallback(prop, value) : fallback;
}
...
function subGetTarget(resolver, prop, value) {
  ...
  if (isArray$2(target) && isObject$2(value)) {
    return value;
  }
  return target;
}
...
class Scale extends Element {
  ...
  drawTitle() {
    ...
    if (position === "bottom" || position === "center" || isObject$2(position)) {
...
class PluginService {
  ...
  _notifyStateChanges(chart2) {
    ...
    this._notify(diff2(previousDescriptors, descriptors2), chart2, "stop");
    this._notify(diff2(descriptors2, previousDescriptors), chart2, "start");
  }
}
...
function createDescriptors(chart2, { plugins: plugins2, localIds }, options, all) {
  ...
  for (const plugin2 of plugins2) {
    ...
    result.push({
      plugin: plugin2,
      options: pluginOpts(chart2.config, { plugin: plugin2, local: localIds[id] }, opts, context)
    });
  }
  return result;
}
...
class Config {
  ...
  resolveNamedOptions(scopes, names2, context, prefixes = [""]) {
    ...
    if (needContext(resolver, names2)) {
      result.$shared = false;
      context = isFunction$2(context) ? context() : context;
  ...
  createResolver(scopes, context, prefixes = [""], descriptorDefaults) {
    ...
    return isObject$2(context) ? _attachContext(resolver, context, void 0, descriptorDefaults) : resolver;
  }
}
...
const hasFunction = (value) => isObject$2(value) && Object.getOwnPropertyNames(value).reduce((acc, key) => acc || isFunction$2(value[key]), false);
function needContext(proxy, names2) {
  ...
  for (const prop of names2) {
    ...
    if (scriptable && (isFunction$2(value) || hasFunction(value)) || indexable && isArray$2(value)) {
      return true;
    }
  }
  return false;
...
class Chart {
  ...
  _updateDatasets(mode) {
    ...
    for (let i = 0, ilen = this.data.datasets.length; i < ilen; ++i) {
      this._updateDataset(i, isFunction$2(mode) ? mode({ datasetIndex: i }) : mode);
    }
...
const invalidatePlugins = () => each(Chart.instances, (chart2) => chart2._plugins.invalidate());
...
function parseBorderRadius(bar, maxW, maxH) {
  ...
  const skip2 = bar.borderSkipped;
  const enableBorder = enableBorderRadius || isObject$2(value);
  return {
...
class Tooltip extends Element {
  ...
  _drawColorBox(ctx, pt, i, rtlHelper, options) {
    ...
    if (options.usePointStyle) {
      ...
      ctx.lineWidth = isObject$2(labelColors.borderWidth) ? Math.max(...Object.values(labelColors.borderWidth)) : labelColors.borderWidth || 1;
      ctx.strokeStyle = labelColors.borderColor;
...
var chartjsPluginColorschemesV3 = { exports: {} };
const require$$1$1 = /* @__PURE__ */ getAugmentedNamespace(chart);
...
(function(module2, exports2) {
  (function(global2, factory) {
    module2.exports = factory(require$$1$1, require$$1);
  })(commonjsGlobal, function(chart_js, helpers2) {
    ...
    function getScheme(scheme) {
      var colorschemes2, matches, arr, category;
      if (Array.isArray(scheme)) {
        return scheme;
      } else if (typeof scheme === "string") {
        colorschemes2 = chart_js.Chart.colorschemes || {};
    ...
    var ColorSchemesPlugin = {
      ...
      beforeUpdate: function(chart2, args, options) {
        ...
        if (scheme) {
          ...
          chart2.config.data.datasets.forEach(function(dataset, datasetIndex) {
            colorIndex = datasetIndex % length;
            newColor = scheme[reverse ? length - colorIndex - 1 : colorIndex];
            dataset[EXPANDO_KEY2] = {};
            switch (dataset.type || chart2.config.type) {
              case "line":
              case "radar":
              case "scatter":
                if (typeof dataset.backgroundColor === "undefined" || override) {
                  dataset[EXPANDO_KEY2].backgroundColor = dataset.backgroundColor;
                  dataset.backgroundColor = helpers2.color(newColor).alpha(fillAlpha).rgbString();
                }
                if (typeof dataset.borderColor === "undefined" || override) {
                  dataset[EXPANDO_KEY2].borderColor = dataset.borderColor;
                  dataset.borderColor = newColor;
                }
                if (typeof dataset.pointBackgroundColor === "undefined" || override) {
                  dataset[EXPANDO_KEY2].pointBackgroundColor = dataset.pointBackgroundColor;
                  dataset.pointBackgroundColor = helpers2.color(newColor).alpha(fillAlpha).rgbString();
                }
                if (typeof dataset.pointBorderColor === "undefined" || override) {
                  dataset[EXPANDO_KEY2].pointBorderColor = dataset.pointBorderColor;
      ...
      afterUpdate: function(chart2) {
        chart2.config.data.datasets.forEach(function(dataset) {
          if (dataset[EXPANDO_KEY2]) {
            if (dataset[EXPANDO_KEY2].hasOwnProperty("backgroundColor")) {
              dataset.backgroundColor = dataset[EXPANDO_KEY2].backgroundColor;
            }
            if (dataset[EXPANDO_KEY2].hasOwnProperty("borderColor")) {
              dataset.borderColor = dataset[EXPANDO_KEY2].borderColor;
            }
            if (dataset[EXPANDO_KEY2].hasOwnProperty("pointBackgroundColor")) {
              dataset.pointBackgroundColor = dataset[EXPANDO_KEY2].pointBackgroundColor;
            }
            if (dataset[EXPANDO_KEY2].hasOwnProperty("pointBorderColor")) {
              dataset.pointBorderColor = dataset[EXPANDO_KEY2].pointBorderColor;
            }
            delete dataset[EXPANDO_KEY2];
          }
        });
      },
      beforeEvent: function(chart2, event, options) {
      },
...
(function(module2, exports2) {
  (function(global2, factory) {
    factory(require$$0, require$$1$1);
  })(commonjsGlobal, function(moment2, Chart2) {
    moment2 = moment2 && Object.prototype.hasOwnProperty.call(moment2, "default") ? moment2["default"] : moment2;
    Chart2 = Chart2 && Object.prototype.hasOwnProperty.call(Chart2, "default") ? Chart2["default"] : Chart2;
    const FORMATS = {
    ...
    Chart2._adapters._date.override(typeof moment2 === "function" ? {
      _id: "moment",
      // DEBUG ONLY
      formats: function() {
        return FORMATS;
...
merge(Label.prototype, {
  ...
  _modelize: function(display, lines, config, context) {
    ...
    var color2 = resolve([config.color, defaults$2.color], context, index2);
    return {
