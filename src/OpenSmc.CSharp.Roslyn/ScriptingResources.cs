namespace OpenSmc.CSharp.Roslyn
{
    internal static class ScriptingResources
    {
        ...
        public static string CannotSetConstantVariable => "Cannot set constant variable";
        public static string StartingStateIncompatible => "Incompatible starting states.";
    }
}
