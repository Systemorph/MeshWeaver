...
namespace OpenSmc.Charting.Helpers
{
    ...
    public record ChartColor
    {
        ...
        public static ChartColor FromRgb(byte r, byte g, byte b) => new() { Red = r, Green = g, Blue = b, Alpha = 1 };
        ...
        public static ChartColor FromHexString(string hexString)
        {
            ...
            try
            {
                ...
                {
                    color.Red = byte.Parse(hexString[..1] + hexString[..1], NumberStyles.HexNumber);
                    color.Green = byte.Parse(hexString[1..2] + hexString[1..2], NumberStyles.HexNumber);
                    color.Blue = byte.Parse(hexString[2..3] + hexString[2..3], NumberStyles.HexNumber);
                    color.Alpha = 1;
                ...
                {
                    color.Red = byte.Parse(hexString[..2], NumberStyles.HexNumber);
                    color.Green = byte.Parse(hexString[2..4], NumberStyles.HexNumber);
                    color.Blue = byte.Parse(hexString[4..6], NumberStyles.HexNumber);
                    color.Alpha = 1;
