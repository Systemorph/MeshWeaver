...
public interface IDataScheduler : IResetable
{
    ...
    void AddModified(IGrouping<Type, object> group, IPartitionVariable partitionVariable, Func<UpdateOptions, UpdateOptions> options = default);
    void AddModified(IEnumerable<object> entities, IPartitionVariable partitionVariable, Func<UpdateOptions, UpdateOptions> options = default);
