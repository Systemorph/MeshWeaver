...
namespace OpenSmc.Scopes.Proxy
{
    ...
    /// </summary>
    public static class DefaultImplementationOfInterfacesExtensions
    {
        public static MethodInfo GetMostSpecificOverride(this object proxy, MethodInfo method)
        {
            ...
            var scopeWithApplicability = proxy as IScopeWithApplicability;

            var mostSpecificOverride =
                scopeWithApplicability?.GetMethod(method) ?? FindMostSpecificOverride(method, proxy.GetType());
