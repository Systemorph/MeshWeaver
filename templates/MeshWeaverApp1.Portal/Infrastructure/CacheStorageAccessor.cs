...
{
    public class CacheStorageAccessor(IJSRuntime js, IAppVersionService vs) : JSModule(js, "./_content/MeshWeaverApp1.Portal.Infrastructure/js/CacheStorageAccessor.js")
    {
