...
public class ImpersonationScopeSiteRatchetGuard(ITestOutputHelper output)
{
    ...
    /// for.</para>
    ///
    /// <para><b>2026-09-17 — 63 → 62, and the two steps were taken independently.</b>
    ...
    /// beside MeshWeaver#4588's new hold, which uses the same shape from the start. 🚨 It met #4618
    /// as a MERGE CONFLICT on this constant, which is what the total check is for: two PRs each
    /// lowering it by one both read "64 → 63", and taking either side alone would have left the
