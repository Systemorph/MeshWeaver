...
public class MigrationWorkloadModelGuard
{
    ...
    [
        ...
        // `content/` holds only content/ai, which leaves with the AI engine (#2276) — so this ONE
        // root is allowed to be absent. It is guarded rather than dropped so the scan keeps working
        // both before and after that move; enumerating it unconditionally would throw
        // DirectoryNotFoundException and take the whole guard down.
