...
public class SearchQueryTests : MonolithMeshTestBase
{
    ...
    public async Task TextSearch_CaseInsensitive_MatchesRegardlessOfCase()
    {
        ...
        // Act
        var results = await MeshQuery.QueryAsync<MeshNode>(request).ToArrayAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Autocomplete_WithBasePath_ReturnsSuggestions()
    {
        ...
        // Act
        var suggestions = await MeshQuery.AutocompleteAsync(basePath, prefix, 10).ToArrayAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Autocomplete_WithNestedPath_ReturnsChildren()
    {
        ...
        var nodes = await MeshQuery.QueryAsync<MeshNode>(nodesRequest).ToArrayAsync(TestContext.Current.CancellationToken);
        ...
        // Act
        var suggestions = await MeshQuery.AutocompleteAsync(nodeWithPotentialChildren.Path!, "", 10).ToArrayAsync(TestContext.Current.CancellationToken);
    ...
    public async Task ReferenceAutocomplete_WithTrailingSlash_DelegatesToAutocomplete()
    {
        ...
        var suggestions = await MeshQuery.AutocompleteAsync(basePath, "", 10).ToArrayAsync(TestContext.Current.CancellationToken);
    ...
    public async Task Search_WithSearchTerm_FiltersResults()
    {
        ...
        var allResults = await MeshQuery.QueryAsync<MeshNode>(allRequest).ToArrayAsync(TestContext.Current.CancellationToken);
        ...
        var filteredResults = await MeshQuery.QueryAsync<MeshNode>(filteredRequest).ToArrayAsync(TestContext.Current.CancellationToken);
