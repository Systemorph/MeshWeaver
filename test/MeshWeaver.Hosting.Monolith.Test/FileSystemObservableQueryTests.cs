...
public class FileSystemObservableQueryTests(ITestOutputHelper output) : MonolithMeshTestBase(output)
{
    ...
    public async Task ObserveQuery_Create_EmitsAddedNotification()
    {
        ...
        var subscription = MeshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery("path:Demos/ACME nodeType:Project scope:descendants"))
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Project1") with
        {
            Name = "Project 1",
            NodeType = "Project"
        });
    ...
    public async Task ObserveQuery_CreateMultiple_EmitsBatchedNotification()
    {
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Project1") with { Name = "Project 1", NodeType = "Project" });
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Project2") with { Name = "Project 2", NodeType = "Project" });
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Project3") with { Name = "Project 3", NodeType = "Project" });
    ...
    public async Task ObserveQuery_FullCRUDCycle_EmitsCorrectNotifications()
    {
        ...
        // UPDATE
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Project1") with { Name = "Updated Project 1", NodeType = "Project" });
        await Task.Delay(300);
    ...
    public async Task ObserveQuery_CRUDWithMultipleSubscribers_AllReceiveNotifications()
    {
        ...
        var subscription2 = MeshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery("path:Demos/ACME scope:descendants"))
    ...
    {
        // Arrange
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME") with { Name = "ACME", NodeType = "Organization" });

        var receivedChanges = new List<QueryResultChange<MeshNode>>();

        var subscription = MeshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery("path:Demos/ACME scope:exact"))
            .Subscribe(change => receivedChanges.Add(change));
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME") with { Name = "ACME Updated", NodeType = "Organization" });
        await Task.Delay(300);
    ...
    public async Task ObserveQuery_ScopeChildren_OnlyNotifiesDirectChildren()
    {
        ...
        var subscription = MeshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery("path:Demos/ACME scope:children"))
            .Subscribe(change => receivedChanges.Add(change));
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Project1/Task1") with { Name = "Task 1", NodeType = "Task" });
        await Task.Delay(300);
    ...
    public async Task ObserveQuery_WithFilter_IgnoresNonMatchingNodes()
    {
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("Demos/ACME/Task1") with { Name = "Task 1", NodeType = "Task" });
        await Task.Delay(300);
    ...
    public async Task ObserveQuery_MoveNode_EmitsDeleteAndCreate()
    {
        ...
        // Act - Move the node
        await Persistence.MoveNodeAsync("Demos/ACME/Project1", "Demos/ACME/Project1Moved");
        await Task.Delay(300);
        ...
        var movedNode = await Persistence.GetNodeAsync("Demos/ACME/Project1Moved");
        movedNode.Should().NotBeNull();
        movedNode!.Name.Should().Be("Project 1");

        // Verify the old node doesn't exist
        var oldNode = await Persistence.GetNodeAsync("Demos/ACME/Project1");
