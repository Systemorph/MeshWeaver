...
public class PathProximityTests
{
    ...
    [InlineData("Systemorph/Marketing", "ACME/Projects", 6.666666666666667)]   // distance=5 (3-segment result)
    ...
    public void ComputeBoost_CloserResultGetsHigherBoost()
    {
        ...
        var farBoost = PathProximity.ComputeBoost(context, "ACME/Projects");
