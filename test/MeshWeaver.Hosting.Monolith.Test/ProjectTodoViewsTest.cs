...
public class ProjectTodoViewsTest(ITestOutputHelper output) : MonolithMeshTestBase(output)
{
    ...
    public async Task MeshQuery_ShouldFindTodosByNodeType()
    {
        ...
        var query = "path:Demos/ACME/ProductLaunch/Todo nodeType:Demos/ACME/Project/Todo scope:subtree";
        ...
        results.Should().OnlyContain(n => n.NodeType == "Demos/ACME/Project/Todo", "All results should be Todo nodes");
    }
    ...
    public async Task MeshQuery_ShouldFilterByNodeType()
    {
        ...
        var queryWithoutFilter = "path:Demos/ACME/ProductLaunch/Todo scope:subtree";
        ...
        var queryWithFilter = "path:Demos/ACME/ProductLaunch/Todo nodeType:Demos/ACME/Project/Todo scope:subtree";
        ...
        filteredResults.Should().OnlyContain(n => n.NodeType == "Demos/ACME/Project/Todo", "All filtered results should be Todo nodes");
    }
