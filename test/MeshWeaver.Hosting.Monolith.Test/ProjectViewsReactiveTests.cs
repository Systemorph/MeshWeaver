...
public class ProjectViewsReactiveTests(ITestOutputHelper output) : MonolithMeshTestBase(output)
{
    ...
    public async Task ObserveQuery_EmitsAddedOnNewTodo()
    {
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("ACME/Software/Project/Todo/task1") with
        {
            Name = "Task 1",
        ...
        var subscription = MeshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery(
                "path:ACME/Software/Project/Todo nodeType:ACME/Software/Project/Todo state:Active scope:subtree"), JsonOptions)
        ...
        // Act - Create new todo
        await Persistence.SaveNodeAsync(MeshNode.FromPath("ACME/Software/Project/Todo/task2") with
        {
            Name = "Task 2",
            NodeType = "ACME/Software/Project/Todo",
            State = MeshNodeState.Active,
    ...
    public async Task ObserveQuery_DeletedItemsAppearInDeletedQuery()
    {
        ...
        var deletedSubscription = MeshQuery
            .ObserveQuery<MeshNode>(MeshQueryRequest.FromQuery(
                "path:ACME/Software/Project/Todo nodeType:ACME/Software/Project/Todo state:Deleted scope:subtree"), JsonOptions)
    ...
    public async Task ObserveQuery_CombineLatestUpdatesOnEitherChange()
    {
        ...
        await Persistence.SaveNodeAsync(MeshNode.FromPath("ACME/Software/Project/Todo/task3") with
        {
