...
public class QueryAsyncIntegrationTests
{
    ...
    {
        // Arrange
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop") { Name = "Laptop", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/phone") { Name = "Phone", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/chair") { Name = "Chair", NodeType = "Furniture" });
    ...
    {
        // Arrange
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop") { Name = "Gaming Laptop Pro", Description = "High performance gaming laptop" });
        await _persistence.SaveNodeAsync(new MeshNode("products/desktop") { Name = "Desktop Computer", Description = "Standard desktop" });
    ...
    {
        // Arrange
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop1") { Name = "Gaming Laptop", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop2") { Name = "Business Laptop", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/chair") { Name = "Gaming Chair", NodeType = "Furniture" });
    ...
    public async Task QueryAsync_ScopeDescendants_SearchesAllChildren()
    {
        ...
        await _persistence.SaveNodeAsync(new MeshNode("org/acme") { Name = "Acme Corp", NodeType = "company" });
        await _persistence.SaveNodeAsync(new MeshNode("org/acme/project") { Name = "Project X", NodeType = "project" });
        await _persistence.SaveNodeAsync(new MeshNode("other/company") { Name = "Other Company", NodeType = "company" });
    ...
    public async Task QueryAsync_InOperator_MatchesMultipleValues()
    {
        ...
        await _persistence.SaveNodeAsync(new MeshNode("products/phone") { Name = "Phone", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/chair") { Name = "Chair", NodeType = "Furniture" });
        await _persistence.SaveNodeAsync(new MeshNode("products/food") { Name = "Food", NodeType = "Groceries" });
    ...
    {
        // Arrange
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop-pro") { Name = "Laptop Pro", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop-basic") { Name = "Laptop Basic", NodeType = "Electronics" });
        await _persistence.SaveNodeAsync(new MeshNode("products/desktop") { Name = "Desktop Computer", NodeType = "Electronics" });
    ...
    {
        // Arrange
        await _persistence.SaveNodeAsync(new MeshNode("products/laptop") { Name = "Laptop" });
        await _persistence.SaveNodeAsync(new MeshNode("products/phone") { Name = "Phone" });
        await _persistence.SaveNodeAsync(new MeshNode("other/chair") { Name = "Chair" });
