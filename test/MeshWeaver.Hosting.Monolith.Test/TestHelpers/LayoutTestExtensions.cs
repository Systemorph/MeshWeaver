...
namespace MeshWeaver.Hosting.Monolith.Test.TestHelpers;
...
public static class LayoutTestExtensions
{
    ...
    public static void AssertHasPropertyEditor(this UiControl root, string propertyName, Type expectedControlType)
    {
        ...
        control!.GetType().Should().Be(expectedControlType,
            $"Property '{propertyName}' should use {expectedControlType.Name}");
    }
