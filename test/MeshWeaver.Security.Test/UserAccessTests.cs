...
public class UserAccessTests(ITestOutputHelper output) : MonolithMeshTestBase(output)
{
    ...
    public async Task GetEffectivePermissions_NamespacedEditor_HasEditorInNamespace()
    {
        ...
        permACME.Should().Be(Permission.Read | Permission.Create | Permission.Update | Permission.Comment | Permission.Execute);
        permChild.Should().Be(Permission.Read | Permission.Create | Permission.Update | Permission.Comment | Permission.Execute);
    ...
    public async Task GetEffectivePermissions_AuthenticatedUser_HasAccessToPrivateNamespace()
    {
        ...
        permAuthUser.Should().Be(Permission.Read | Permission.Create | Permission.Update | Permission.Comment | Permission.Execute);
    }
