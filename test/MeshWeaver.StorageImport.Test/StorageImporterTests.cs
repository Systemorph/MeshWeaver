...
public class StorageImporterTests : IDisposable
{
    ...
    public async Task SubtreeImport_CopiesOnlySubtree()
    {
        ...
        // Act
        var result = await importer.ImportAsync(new StorageImportOptions { RootPath = "ACME" }, ct: ct);
    ...
    public async Task PartitionImport_TransfersPartitionData()
    {
        ...
        // Act
        var result = await importer.ImportAsync(new StorageImportOptions { ImportPartitions = true }, ct: ct);
    ...
    public async Task RemoveMissing_DeletesTargetNodesNotInSource()
    {
        ...
        var result = await importer2.ImportAsync(new StorageImportOptions { RemoveMissing = true }, ct: ct);
    ...
    public async Task RemoveMissing_False_DoesNotDeleteAnything()
    {
        ...
        var result = await importer2.ImportAsync(new StorageImportOptions { RemoveMissing = false }, ct: ct);
