...
public class ChartTests
{
    ...
    public async Task Bar_Chart_Basic()
    {
        ...
        var chart3 = ChartBuilder.Bar()
                          .WithData(data)
                          .WithLabels(labels)
                          .WithTitle("My First Chart", o => o.AtPosition(Positions.Left))
                          .ToChart();

        await chart3.JsonShouldMatch("Bar_Chart_Basic.json");
    }
    ...
    public async Task Line_Chart_Basic()
    {
        ...
        var chart3 = ChartBuilder.Line()
                          .WithDataSet(b => b.WithData(data)
                                             .Smoothed())
                          .WithTitle("My First Chart", o => o.AtPosition(Positions.Left))
                          .WithLabels(labels)
                          .ToChart();

        await chart3.JsonShouldMatch("Line_Chart_Basic.json");
    }
    ...
    public async Task Line_Chart_Times()
    {
        ...
        var myChart = ChartBuilder.TimeLine()
                           .WithDataSet(b => b.WithData(times, data)
                                              .Smoothed())
                           .WithOptions(o => o.SetTimeUnit(TimeIntervals.Day)
                                              .SetTimeFormat("D MMM YYYY"))
                           .WithTitle("Timed Chart", o => o.AtPosition(Positions.Bottom).WithFontSize(20))
                           .ToChart();

        await myChart.JsonShouldMatch("Line_Chart_Times.json");
    }
    ...
    public async Task Bar_Chart_Stacked()
    {
        ...
        var myChart = ChartBuilder.Bar()
                           .WithDataSet(b => b.WithData(data1)
                                              .WithLabel("One"))
                           .WithDataSet(b => b.WithData(data2)
                                              .WithLabel("Two"))
                           .Stacked()
                           .WithLabels(labels)
        ...
        await myChart.JsonShouldMatch("Bar_Chart_Stacked.json");
    }
    ...
    public async Task Bar_Chart_NoAnimation()
    {
        ...
        await myChart.JsonShouldMatch("Bar_Chart_NoAnimation.json");
    }
    ...
    public async Task EmptyBarChart()
    {
        var myChart = ChartBuilder.Bar()
                                  ...
                                  .ToChart();
        await myChart.JsonShouldMatch("Empty_Bar_Chart.json");
    }
    ...
    public async Task Bar_Chart_Floating()
    {
        ...
        var chart3 = ChartBuilder.FloatingBar()
                          .WithDataRange(low, high)
                          .WithLabels(labels)
                          .WithTitle("Floating", o => o.AtPosition(Positions.Top))
                          .ToChart();

        await chart3.JsonShouldMatch("Bar_Chart_Floating.json");
    }
    ...
    public async Task Bar_Chart_Floating_Stacked()
    {
        ...
        await chart3.JsonShouldMatch("Bar_Chart_Floating_Stacked.json");
    }
    ...
    public async Task Bar_Chart_Waterfall()
    {
        ...
        var chart3 = ChartBuilder.Waterfall()
                                 .WithDeltas(deltas)
        ...
        await chart3.JsonShouldMatch("Bar_Chart_Waterfall.json");
    }
    ...
    public async Task Bar_Chart_HorizontalWaterfall()
    {
        ...
        var chart3 = ChartBuilder.HorizontalWaterfall()
                                 .WithDeltas(deltas)
                                 .WithLegendItems("Increments", "Decrements", "Total")
                                 .WithConnectors()
                                 .WithLabels(labels)
        ...
        await chart3.JsonShouldMatch("Bar_Chart_HorizontalWaterfall.json");
    }
    ...
    public async Task Bar_Chart_Waterfall_AutoTotal()
    {
        ...
        await chart3.JsonShouldMatch("Bar_Chart_Waterfall_AutoTotal.json");
    }
    ...
    public async Task Bar_Chart_Waterfall_MarkedTotals()
    {
        ...
        string[] labels = { "Main1", "Delta1", "Delta2", "Middle", "Delta3", "Delta4", "Delta5", "Total" };
        ...
        await chart3.JsonShouldMatch("Bar_Chart_Waterfall_MarkedTotals.json");
    }
    ...
    public async Task Bar_Chart_HorizontalWaterfall_MarkedTotals()
    {
        ...
        await chart3.JsonShouldMatch("Bar_Chart_HorizontalWaterfall_MarkedTotals.json");
    }
    ...
    public async Task Bar_Chart_Waterfall_StyledBars()
    {
        ...
        await chart3.JsonShouldMatch("Bar_Chart_Waterfall_StyledBars.json");
    }
    ...
    public async Task Bar_Chart_HorizontalWaterfall_AutoTotal()
    {
        ...
        await chart3.JsonShouldMatch("Bar_Chart_HorizontalWaterfall_AutoTotal.json");
    }
    ...
    public async Task Bar_Chart_Horizontal_Floating()
    {
        ...
        var chart3 = ChartBuilder.HorizontalFloatingBar()
                                 .WithDataRange(first, "first")
                                 .WithDataRange(second, "second")
                                 .WithLabels(labels)
        ...
        await chart3.JsonShouldMatch("Bar_Chart_Horizontal_Floating.json");
    }
    ...
    public async Task Bar_Chart_Palette()
    {
        ...
        await myChart.JsonShouldMatch("Bar_Chart_Palette.json");
    }
    ...
    public async Task Bar_Chart_AutoLegend()
    {
        ...
        await myChart.JsonShouldMatch("Bar_Chart_AutoLegend.json");

        var myChart2 = ChartBuilder.Bar()
                            .WithDataSet(b => b.WithData(data)
                                               .WithLabel("First"))
                            .WithLabels(labels)
                            .WithTitle("My First Chart", o => o.AtPosition(Positions.Left))
        ...
        await myChart2.JsonShouldMatch("Bar_Chart_AutoLegend_WithTitle.json");
    }
    ...
    public async Task Bar_Chart_SetMinimum()
    {
        ...
        await myChart.JsonShouldMatch("Bar_Chart_SetMin.json");
        ...
        await myChart2.JsonShouldMatch("Bar_Chart_SetMinMax.json");
    }
    ...
    public async Task CustomPalette()
    {
        ...
        var myChart = ChartBuilder.Pie()
                           .WithData(data)
                           .WithLabels(labels)
                           .WithLegend()
                           .WithColorPalette(myPalette);

        await myChart.ToChart().JsonShouldMatch("CustomPalette1.json");

        var myChartWithStringColor = myChart.WithColorPalette(Palettes.Brewer.YlGn8).ToChart();
        await myChartWithStringColor.JsonShouldMatch("CustomPalette2.json");
    }
    ...
    public async Task QuickDraw()
    {
        ...
        await actual.JsonShouldMatch("QuickDraw.json");
    }
    ...
    public async Task AreaChart()
    {
        ...
        await actual.JsonShouldMatch("AreaChart.json");
    }
    ...
    public async Task Generate_BubbleChart_Generates_Valid_Chart()
    {
        ...
        await actual.JsonShouldMatch("BubbleChart.json");
    }
    ...
    {
        var actual = ChartBuilder.Scatter()
                          .WithDataPoint(new[]
                                         {
                                             (-10, 0),
                                             (0, 10),
                          ...
                          .WithOptions(o => o.WithScales(("x", new CartesianLinearScale
                          {
                              Type = "linear",
                              Position = "bottom",
                              BeginAtZero = true
        ...
        await actual.JsonShouldMatch("LineScatter.json");
    }
    ...
    public async Task GenerateScatterWithLabels()
    {
        ...
        var plot = ChartBuilder.Scatter()
                               ...
                               .ToChart();
        await plot.JsonShouldMatch($"{nameof(GenerateScatterWithLabels)}.json");
    }
}