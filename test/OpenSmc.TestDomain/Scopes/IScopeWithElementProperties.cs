...
namespace OpenSmc.TestDomain.Scopes
{
        ...
        IScope<YearQuarterAndCompany, YearAndQuarterAndCompanyIdentityStorage>, IDataCube<CashflowElement>
    {
        ...
        CashflowElement BoP => new CashflowElement { Country = Country.Data.First().SystemName, AmountType = AmountType.Data.First().SystemName, Currency = Currency.Data.First().SystemName, Value = 0 };

        CashflowElement Delta => new CashflowElement { Country = Country.Data.First().SystemName, AmountType = AmountType.Data.First().SystemName, Currency = Currency.Data.First().SystemName, Value = 1 };
