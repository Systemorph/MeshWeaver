...
namespace OpenSmc.TestDomain.SimpleData
{
    ...
    public record TwoDimValue
    {
        ...
        {
            new() { Dim1 = null, Dim2 = "A", Value = 1 },
            new() { Dim1 = null, Dim2 = "B", Value = 2 },
            new() { Dim1 = "a", Dim2 = "A", Value = 3 },
            new() { Dim1 = "a", Dim2 = "B", Value = 4 },
            new() { Dim1 = "c", Dim2 = "C", Value = 5 },
            new() { Dim1 = "c", Dim2 = "D", Value = 6 }
        };
    }
}